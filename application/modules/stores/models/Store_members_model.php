...
class store_members_model extends MY_Model{
    var $PKG_NAME= "STORES_PKG";
    var $TABLE_NAME= 'STORE_MEMBERS_TB';
   ...
   function get($id){
    ...
    function delete( $committees_id,$emp_no){
        $params =array(
        array('name'=>':COMMITTEES_ID_IN','value'=>$committees_id,'type'=>'','length'=>-1),
