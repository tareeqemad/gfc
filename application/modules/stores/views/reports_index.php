...
<div class="row">
    ...
    <div class="form-body">
        <ul class="cpanel">
            ...
            <?php if(1): ?> <li><a onclick="javascript:account_create();" href="javascript:;" id="a4"> الاصناف الراكدة</a> </li><?php endif;?>
        </ul>
    ...
    <form class="form-vertical" id="<?=$TB_NAME?>_form3" >
        <div class="modal-body inline_form3">

            <div class="form-group col-sm-3 rp_prm">
                <label class="col-sm-3 control-label"> بعد تاريخ </label>
                <div class="col-sm-6">
                    <input type="text" data-type="date" value="<?=date('01/01/Y')?>" data-date-format="DD/MM/YYYY" id="txt_from_month" class="form-control"/>
                </div>
            </div>
            ...
            <div class="form-group col-sm-3 rp_prm">
                <label class="col-sm-3 control-label">لديها حركات اقل من </label>
                <div class="col-sm-3">
                    <input type="text" value="5" id="txt_duration_no" class="form-control"/>
                </div>
            </div>
...
else if($('#a4').data('clicked'))
{
    var from_date = $('#txt_from_month').val();
    var duration = $('#txt_duration_no').val();
    url = '{$report_url2}&report_type=pdf&report=unused_class&p_date='+from_date+'&p_duration='+duration;
 }
_showReport(url);
}
</script>
