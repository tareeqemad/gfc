            ...
            <section id="values" class="values" style="margin-right: 10px">
                <div class="container" data-aos="fade-up">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
                            <div class="box" style="direction: rtl; border-bottom: 3px solid  #08da4e ;border-radius: 5px;"><a href="<?= base_url('/biunit/Da3em/index')?>">
                        ...
                        <div class="col-md-3 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
                            <div class="box last" style="direction: rtl; border-bottom: 3px solid #2db6fa;border-radius: 5px;"><a href="<?= base_url('Biunit/smartGrid')?>">
                                <img src="<?=base_url('assets/images/bi-imgs/smart.png');?>"  class="img-fluid" alt="">
                                    <h3> الحلول الفنية ودعـم الشبكة الذكية </h3></a>
                            </div>
                        </div>
                        <div class="col-md-3 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
                            <div class="box" style="direction: rtl; border-bottom: 3px solid  #ef0404 ;border-radius: 5px;"><a href="">
