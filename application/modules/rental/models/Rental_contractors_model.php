...
class rental_contractors_model extends MY_Model{
    var $PKG_NAME= "SERV_RENT_PKG";
    var $TABLE_NAME= 'RENTAL_CONTRACTORS_TB';
    ...
    function get($id= 0){
        ...
        $params =array(
            array('name'=>':CONTRACTOR_FILE_ID','value'=>$id ,'type'=>'','length'=>-1),
    ...
    function get_all($branch='', $contract_case=1){

        $params =array(
            array('name'=>':BRANCH','value'=>$branch ,'type'=>'','length'=>-1),
            array('name'=>':CONTRACT_CASE','value'=>$contract_case ,'type'=>'','length'=>-1),
            array('name'=>':REF_CUR_OUT','value'=>'cursor','type'=>OCI_B_CURSOR),
            array('name'=>':MSG_OUT','value'=>'MSG_OUT','type'=>'','length'=>500)
        );
    ...
    function contract_case($id, $case){
        $params =array(
            array('name'=>':CONTRACTOR_FILE_ID','value'=>$id,'type'=>'','length'=>-1),
    ...
    function edit_branch($id, $branch){
        ...
        $result = $this->conn->excuteProcedures($this->PKG_NAME, $this->TABLE_NAME.'_BRANCH',$params);
        return $result['MSG_OUT'];
    }
