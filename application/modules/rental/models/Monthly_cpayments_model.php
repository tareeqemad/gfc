...
class monthly_cpayments_model extends MY_Model{
    var $PKG_NAME= "SERV_RENT_PKG";
    var $TABLE_NAME= 'MONTHLY_CPAYMENTS_TB';
    ...
    function get($id= 0){
        ...
        $params =array(
            array('name'=>':MONTHLY_CPAYMENTS_ID','value'=>$id ,'type'=>'','length'=>-1),
    ...
    function cancel($id, $case,$note_4){
        $params =array(
            array('name'=>':MONTHLY_CPAYMENTS_ID','value'=>$id,'type'=>'','length'=>-1),
            array('name'=>':ADOPT','value'=>$case,'type'=>'','length'=>-1),
            array('name'=>':NOTE_4','value'=>$note_4,'type'=>'','length'=>-1),
            array('name'=>':MSG_OUT','value'=>'MSG_OUT','type'=>'','length'=>500)
        );
