...
<td><?=@$row['SECOND_CLASS_NAME']?></td>
    ...
    <?php
           if(($row['T_ADOPT_NORTH']!=2 OR $row['ADOPT_NORTH']!=2) OR ($row['T_ADOPT_GAZA']!=2 OR $row['ADOPT_GAZA']!=2 )OR ($row['T_ADOPT_MIDDEL']!=2 OR $row['ADOPT_MIDDEL']!=2)OR ($row['T_ADOPT_KHAN']!=2 OR $row['ADOPT_KHAN']!=2) OR ($row['T_ADOPT_RAFAH']!=2 OR $row['ADOPT_RAFAH']!=2)) {?>
