...
search();
    ...
    function getReportUrl(rep_id){
        ...
        var sector=$('#dp_sector').val();
        var branch = $('#dp_br').val();
        if (sector ==-2)
        sector='';		var rep_type = $('input[name=rep_type]:checked').val();
   ...
   switch(rep_id) {
            case "1":
  repUrl = '{$report_url}&report_type='+rep_type+'&report='+branch_name+'_indicators_performance'+rep_t+'&p_sector='+sector+'&p_class='+$('#dp_class').val()+'&p_from_month='+for_month+'&p_branch='+branch+'&p_adopt='+$('#dp_adopt').val()+'&p_effect=1'+'&p_second_class='+$('#dp_second_class').val()+'';
                break;
            case "2":
 repUrl = '{$report_url}&report_type='+rep_type+'&report=comparison_of_headquarters_performance'+rep_t+'&p_sector='+sector+'&p_class='+$('#dp_class').val()+'&p_from_month='+for_month+'&p_adopt='+$('#dp_adopt').val()+'&p_effect=1'+'&p_second_class='+$('#dp_second_class').val()+'';
                break;
        }
        return repUrl;
    }
