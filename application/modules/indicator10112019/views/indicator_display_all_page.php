...
<?php foreach($page_rows as $row) :
    ...
    <td class="hidden"><?=@$row['WEIGHT']?><input type="hidden" name="weight[]" value="<?=@$row['WEIGHT']?>" />
    ...
    <td>
        <div class="row">
            <div class="col-md-4">
                ...
                if($target_north==0)
                    $target_north = 'لايمكن القسمة على صفر';
                else
                    $target_north =@$row['NORTH_T_PERSENT'];

                ?>
                <input class="form-control" name="north_t_persent[]" value="<?=@$target_north.'%';?>" id="txt_north_t_differ_<?=$count?>" data-val="false" data-val-required="required" />
            ...
            {
            if((@$row['NORTH_T_PERSENT']-100)>($row['EFFECT_VALUE']*-1))//if($differ<($row['EFFECT_VALUE']/100))
            ...
            <div class="col-md-4" style="background-color: lightgrey; border: 8px solid green;">
                ...
                <div class="col-md-4" style="background-color: lightgrey; border: 8px solid red;">
                    ...
                    else  if($row['NORTH_T_PERSENT'] == ($row['EFFECT_VALUE']/100))//if($row['NORTH_T_DIFFER'] == ($row['EFFECT_VALUE']/100))
                    {
                    ?>
                        ...
                        <div class="col-md-4" style="background-color: lightgrey; border: 8px solid green;">
                            ...
                            <div class="col-md-4" style="background-color: lightgrey; border: 8px solid red;">
                                ...
                                <div class="col-md-4" style="background-color: lightgrey; border: 8px solid #ffff00;">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" name="prev_value_north[]" value="<?=@$row['NORTH_T_ORDER']?>" readonly  />
    ...
    <td>
        <div class="col-md-4">
            ...
            if($target_gaza==0)
                $target_gaza = 'لايمكن القسمة على صفر';
            else
                $target_gaza =@$row['GAZA_T_PERSENT'];


            ?>
            <input class="form-control" name="gaza_t_persent[]" value="<?=@$target_gaza.'%';?>" id="txt_gaza_t_persent_<?=$count?>" data-val="false" data-val-required="required" />
                    ...
                    <div class="col-md-4" style="background-color: lightgrey; border: 8px solid green;">
                        ...
                        <div class="col-md-4" style="background-color: lightgrey; border: 8px solid red;">
                            ...
                            <div class="col-md-4" style="background-color: lightgrey; border: 8px solid #ffff00;">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" name="prev_value_gaza[]" value="<?=@$row['GAZA_T_ORDER']?>" readonly  />
    ...
    <td>
        <div class="col-md-4">
            ...
            if($target_middle==0)
                $target_middle = 'لايمكن القسمة على صفر';
            else
                $target_middle =@$row['MIDDLE_T_PERSENT'];

            ?>
            <input class="form-control" name="txt_middle[]" value="<?=@$target_middle.'%';?>" id="txt_middle_<?=$count?>" data-val="false" data-val-required="required" />
                    ...
                    <div class="col-md-4" style="background-color: lightgrey; border: 8px solid green;">
                        ...
                        <div class="col-md-4" style="background-color: lightgrey; border: 8px solid red;">
                            ...
                            <div class="col-md-4" style="background-color: lightgrey; border: 8px solid #ffff00;">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" name="prev_value_middle[]" value="<?=@$row['MIDDLE_T_ORDER']?>" readonly  />
    ...
    <td>
        <div class="col-md-4">
            ...
            if($target_khan==0)
                $target_khan = 'لايمكن القسمة على صفر';
            else
                $target_khan =@$row['KHAN_T_PERSENT'];

            ?>
            <input class="form-control" name="txt_khan[]" value="<?=@$target_khan.'%';?>" id="txt_khan_<?=$count?>" data-val="false" data-val-required="required" />
       ...
       // if($row['KHAN_T_DIFFER']<($row['EFFECT_VALUE']/100))
        ...
        <div class="col-md-4" style="background-color: lightgrey; border: 8px solid green;">
            ...
            else  if((@$row['KHAN_T_PERSENT']-100)<($row['EFFECT_VALUE']*-1))//if($row['KHAN_T_DIFFER']>($row['EFFECT_VALUE']/100))
            {
            ?>
            <div class="col-md-4" style="background-color: lightgrey; border: 8px solid red;">
                    ...
                    <div class="col-md-4" style="background-color: lightgrey; border: 8px solid green;">
                        ...
                        <div class="col-md-4" style="background-color: lightgrey; border: 8px solid red;">
                            ...
                            <div class="col-md-4" style="background-color: lightgrey; border: 8px solid #ffff00;">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" name="prev_value_khan[]" value="<?=@$row['KHAN_T_ORDER']?>" readonly  />
    ...
    <td>
        <div class="col-md-4">
            ...
            if($target_rafa==0)
                $target_rafa = 'لايمكن القسمة على صفر';
            else
                $target_rafa =@$row['RAFA_T_PERSENT'];

            ?>
            <input class="form-control" name="txt_rafa[]" value="<?=@$target_rafa.'%';?>" id="txt_rafa_<?=$count?>" data-val="false" data-val-required="required" />
                    ...
                    <div class="col-md-4" style="background-color: lightgrey; border: 8px solid green;">
                        ...
                        <div class="col-md-4" style="background-color: lightgrey; border: 8px solid red;">
                            ...
                            <div class="col-md-4" style="background-color: lightgrey; border: 8px solid #ffff00;">
                                ...
                                <div class="col-md-4">
                                    <input class="form-control" name="prev_value_rafa[]" value="<?=@$row['RAFA_T_ORDER']?>" readonly  />
    ...
    <div class="col-md-4">
        <table class="table">
            ...
            <tr>
                ...
                <th id="n_amount_total"><?=@$count_t_wegith_north+@$count_t_wegith_gaza+@$count_t_wegith_khan+@$count_t_wegith_middle+@$count_t_wegith_rafah;?></th>
            ...
            <tr>
                ...
                else
                {
                    ...
                    $total=round(((@$count_t_wegith_north+@$count_t_wegith_gaza+@$count_t_wegith_khan+@$count_t_wegith_middle+@$count_t_wegith_rafah)/$count_weight)*100);
                }
                ?>
