...
<tr>
    ...
    <th>
        ...
        <div class="row">
            ...
            <div class="col-md-2" data-toggle="tooltip" data-placement="top" title="">مستهدف</div>
            <div class="col-md-2">محقق</div>
            <div class="col-md-2">الفرق</div>
            <div class="col-md-2">%</div>
            <div class="col-md-1">الحالة</div>
            <div class="col-md-1">#</div>
            <div class="col-md-1 hidden">الوزن</div>
            <div class="col-md-2">                حالة اعتماد المستهدف
            </div>
...
<?php
    ...
    <div class="row">
        <div class="col-md-2">
            <input class="form-control" name="t_value[]" value="<?=@$target;?>" id="txt_north_<?=$count?>" data-val="false" data-val-required="required" />
            <input type="hidden" name="t_indecator_ser[]" id="north_seq_id_<?= $count ?>" value="<?=@$row['NORTH_SEQ']?>" data-check='<?=@$row['NORTH_SEQ']?>' /></div>
        <div class="col-md-2">
            <input class="form-control" name="prev_north[]" value="<?=@$row['VALUE_DATA']?>" readonly  />
        </div>
        <div class="col-md-2">
            <?php
            if($row['T_ADOPT']!=2)

            {
                if($row['SCALE']==2)
                {
                    ...
                    ?>
                    <input class="form-control" name="differ_north[]" value="<?=(@$row['VALUE_DATA']-$target)/100;?>" readonly  />
                <?php
                }
                else
                {
                    ...
                    ?>
                    <input class="form-control" name="differ_north[]" value="<?=(@$row['VALUE_DATA']-$target);?>" readonly  />
                <?php
                }
            }
            else
            {
                $differ=@$row['T_DIFFER'];
                ?>
                <input class="form-control" name="T_DIFFER[]" value="<?=@$row['T_DIFFER'];?>" readonly  />
            <?php
            }
            ?>
        </div>
                        ...
                        <div class="col-md-1" style="background-color: lightgrey; border: 8px solid red;">
                            ...
                            <div class="col-md-1" style="background-color: lightgrey; border: 8px solid #ffff00;">
                                ...
                                <div class="col-md-1 hidden">
                                    ...
                                    <input class="form-control" name="t_wegith[]" value="<?=@$row['T_WEGITH'];?>" readonly  />
...
<table class="table hidden" style="width: 50%">
    ...
    <tr>
        ...
        ?>
        <th id="n_amount_total"><?=$total.' % '.@$sign;?></th>
