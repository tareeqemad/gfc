...
class HPP_model extends MY_Model{
    ...
    function get_list($sql,$offset,$row){
        ...
        $result = $this->New_rmodel->general_get('TECHNICAL_PKG','HIGH_POWER_PARTITION_TB_LIST',$params);
    ...
    function get($id = 0){
        ...
        $result = $this->New_rmodel->general_get('TECHNICAL_PKG','HIGH_POWER_PARTITION_TB_GET',$params);
