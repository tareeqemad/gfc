    ...
    <table class="table" id="details_tb" data-container="container">
        ...
        <?php if(count($details) <= 0) {  // ادخال ?>
            <tr>
                ...
                <td>
                    <input class="form-control" name="jawwal[]" id="txt_jawwal<?=$count?>" />
                </td>
        ...
        <?php
            ...
            foreach($details as $row) {
                ...
                <tr>
                    ...
                    <td>
                        <input class="form-control" name="jawwal[]" value="<?=$row['JAWWAL']?>" id="txt_jawwal<?=$count?>" />
                    </td>
