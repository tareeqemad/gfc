...
<?php if (count($details) <= 0) { // ادخال ?>
    ...
    <tr>
        ...
        <td>
            ...
            <input name="adapter_serial[]" data-not-empty="true" type="hidden"
                   value="<?= $workOrderData != null ? $workOrderData['SOURCE_ID'] : '' ?>"
                   id="h_txt_adapter_serial_<?= $count ?>" class="form-control">
            <input name="adapter_serial_name[]" data-not-empty="true" readonly id="txt_adapter_serial_<?= $count ?>"
                   value="<?= $workOrderData != null ? $workOrderData['SOURCE_ID_NAME'] : '' ?>" class="form-control">
        </td>
        ...
        <tr>
            ...
            <td>
                ...
                <input name="adapter_serial[]" data-not-empty="true" type="hidden" value="<?= $row['ADAPTER_SERIAL'] ?>"
                       id="h_txt_adapter_serial_<?= $count ?>" class="form-control">
                <input name="adapter_serial_name[]" data-not-empty="true" readonly
                       value="<?= $row['ADAPTER_SERIAL_NAME'] ?>"
...
<tr>
    ...
    <th>
        ...
        <a onclick="javascript:add_row(this,'input',false);"
           onfocus="javascript:add_row(this,'select,input:not(\'input[data-not-empty]\')',false);"
