...
class poles_model extends MY_Model
{
    ...
    function get_list($sql,$offset,$row){
        ...
        $result = $this->New_rmodel->general_get($this->PKG_NAME,'POLES_ALL_FINAL_LIST',$params);
        return $result;
    }
    /**********************************edit function*****************************************/
    function edit($data){
    ...
    function get_poles($id= 0){
        ...
        $result = $this->New_rmodel->general_get($this->PKG_NAME,'POLES_ALL_FINAL_GET',$params);
       //var_dump($result);
       //die();
        return $result;
    }
