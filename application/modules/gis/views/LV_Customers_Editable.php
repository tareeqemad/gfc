...
require([
    ...
    layers = new ArcGISDynamicMapServiceLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/Gaza_customers/MapServer");
    ...
    var  CUSTOMERS   = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/Gaza_customers/FeatureServer/0", {
    ...
    var LV_SWITCHES = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/Gaza_customers/FeatureServer/2",{
        mode: FeatureLayer.MODE_ONDEMAND,
        outFields: ["*"]
    });
    var LV_POLES  = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/Gaza_customers/FeatureServer/3", {
        mode: FeatureLayer.MODE_ONDEMAND,
        outFields: ["*"]
    });
    var LV_NETWORK  = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/Gaza_customers/FeatureServer/4", {
        mode: FeatureLayer.MODE_ONDEMAND,
        outFields: ["*"]
    });
    ...
    map.addLayers([LV_NETWORK,LV_POLES,LV_SWITCHES,CUSTOMERS_CABLE,CUSTOMERS]);
