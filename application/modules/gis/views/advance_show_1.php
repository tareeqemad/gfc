...
<!--
 ...
 var search = new Search({
        enableButtonMode: false,//true, //this enables the search widget to display as a single button
        enableLabel:false, //true,
        enableInfoWindow:false, //true,
        showInfoWindowOnSelect: true,
		enableSuggestions:false,//true,
        map: map
      }, "search");
      var  MV_OUTDOOR_SWITCHES  = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/MapServer/0", {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////	  
      var  TRANSFORMERS  = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/MapServer/1", {
        mode: FeatureLayer.MODE_ONDEMAND,
        outFields: ["*"]/*,
...
infoTemplate: new InfoTemplate("TRANSFORMERS", "${*}")
	 ...
	 // TRANSFORMERS.setDefinitionExpression("GOVERNORATE_NAME = '<?php echo $branch?>'");
	  ...
	  var  MV_POLES1  = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/MapServer/2", {
        mode: FeatureLayer.MODE_ONDEMAND,
        outFields: ["*"],
	  ...
	  //////////////////////////////////////////////////////////////////
	  var  M_V_NETWORK   = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/MapServer/3", {
        mode: FeatureLayer.MODE_ONDEMAND,
        outFields: ["*"],
