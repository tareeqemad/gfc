...
require([
   ...
   /* var  MV_LBS  = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/1", {
    ...
    var ROOMS_NEW = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/5", {
	 ...
	 var  MV_LBS  = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/101", {
        mode: FeatureLayer.MODE_ONDEMAND,
        outFields: ["*"]
    });

    var MV_OUTDOOR_SWITCHES = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/101", {
        mode: FeatureLayer.MODE_ONDEMAND,
        outFields: ["*"]
    });
    var TRANSFORMERS = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/201",{
        mode: FeatureLayer.MODE_ONDEMAND,
        outFields: ["*"]
    });
    var MV_POLES1 = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/301", {
        mode: FeatureLayer.MODE_ONDEMAND,
        outFields: ["*"]
    });
    var M_V_NETWORK = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/401", {
        mode: FeatureLayer.MODE_ONDEMAND,
        outFields: ["*"]
    });

    var ROOMS_NEW = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/501", {
        mode: FeatureLayer.MODE_ONDEMAND,
        outFields: ["*"]
    });
