...
<!--
 ...
 var search = new Search({
	  ...
	  var  MV_LBS  = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/101", {//new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/MapServer/0", {
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
 var  MV_OUTDOOR_SWITCHES  = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/101", {//new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/MapServer/1",
	  //{
	  ...
	  //MV_OUTDOOR_SWITCHES.setDefinitionExpression("GOVERNORATE_NAME = '<?php echo $branch?>'");
//////////////////////////////////////////////////////////////////////////////////////////////////////////	
 var  TRANSFORMERS  = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/201", {//new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/MapServer/2", {  
...
infoTemplate: new InfoTemplate("TRANSFORMERS", "${*}")
	 ...
	 // TRANSFORMERS.setDefinitionExpression("GOVERNORATE_NAME = '<?php echo $branch?>'");
	  ///////////////////////////////////////////////////////////////////////////////////////////////////////
	  var  MV_POLES1  = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/301", {//new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/MapServer/3", {  
	 // var  MV_POLES1  = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/3", {//new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/MapServer/3", {
	  ...
	  //////////////////////////////////////////////////////////////////
	    var  M_V_NETWORK   = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/401", {//new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/MapServer/4", {
	//  var  M_V_NETWORK   = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/4", {//new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/MapServer/4", {
	   ...
	   //////////////////////////////////////////////////////////////////
	   var  ROOMS_NEW   = new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/FeatureServer/501", {//new FeatureLayer("https://gisweb.gedco.ps:6443/arcgis/rest/services/GIS_GEDCO/s/MapServer/5", {
