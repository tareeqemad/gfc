...
$isCreate =isset($issues_data) && count($issues_data)  > 0 ?false:true;
$isCreate2 =isset($issues_data_exec) && count($issues_data_exec)  > 0 ?false:true;
$rs=($isCreate)? array(): (count($issues_data) > 0 ? $issues_data[0] : array()) ;
$rs_exec=($isCreate)? array(): (count($issues_data_exec) > 0 ? $issues_data_exec[0] : array()) ;
...
$get_url =base_url("$MODULE_NAME/$TB_NAME/get_exec_issue_info");
$edit_url =base_url("$MODULE_NAME/$TB_NAME/edit");
$hide_branch_no='';
$hide_branch_name='';

if(count($issues_data_exec) > 0) {
...
<input type="hidden" value="<?php echo @$rs['SER'];?>" name="ser_issue_type" id="txt_ser_issue_type">
...
<fieldset  class="field_set">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="text" readonly   name="ser" id="txt_SER" class="form-control" value="<?php echo @$rs_exec['SER'] ;?>">
        </div>
        <?php foreach($branches as $row) :
            if($row['NO']== @$rs['ISSUE_BRANCH'])
            {
                $hide_branch_no=$row['NO'];
                $hide_branch_name=$row['NAME'];
        ...
        <div class="col-sm-2">
            <input type="text" data-val="true" readonly  value="<?php echo $hide_branch_name ;?>"   data-val-required="حقل مطلوب" name="issue_branch_name" id="txt_issue_branch" class="form-control"  >



            <input type="hidden" value="<?php echo $hide_branch_no;?>" name="issue_branch" id="issue_branch">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <input type="text" readonly data-val="true"   value="<?php echo @$rs['SUB_NO'] ;?>"  placeholder="رقم الاشتراك"   data-val-required="حقل مطلوب" name="sub_no" id="txt_sub_no" class="form-control"  >
            ...
            <div class="col-sm-2">
                <input type="text" data-val="true" value="<?php echo @$rs['SUB_NAME'] ;?>" placeholder="اسم المشترك"  data-val-required="حقل مطلوب" name="sub_name" id="txt_sub_name" class="form-control" readonly>
            ...
            <div class="col-sm-2">
                <input type="text" data-val="true" value="<?php echo @$rs['ID'] ;?>"  placeholder="رقم الهوية"  data-val-required="حقل مطلوب" name="id" id="txt_id" class="form-control" readonly >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-2">
                <input type="text" data-val="true" value="<?php echo @$rs['FOR_MONTH'] ;?>" placeholder="شهر الفاتورة" data-val-required="حقل مطلوب" name="for_month" id="txt_for_month" class="form-control" readonly >
            ...
            <div class="col-sm-2">
                <input type="text" data-val="true" value="<?php echo @$rs['NET_PAY'] ;?>" placeholder="قيمة الفاتورة" data-val-required="حقل مطلوب" name="net_pay" id="txt_net_pay" class="form-control" readonly >
            ...
            <div class="col-sm-2">
                <input type="text" data-val="true" value="<?php echo @$rs['TYPE_NAME_SHOW'] ;?>"   placeholder="نوع الاشتراك"  data-val-required="حقل مطلوب" name="type_name" id="txt_type_name" class="form-control" readonly>
                <input type="hidden" data-val="true" value="<?php echo @$rs['TYPE_NAME'] ;?>"  placeholder="نوع الاشتراك"  data-val-required="حقل مطلوب" name="type_pa" id="txt_type_pa" class="form-control" >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" value="<?php echo @$rs['ADDRESS'] ;?>" data-val="true" placeholder="العنوان"   data-val-required="حقل مطلوب" name="address" id="txt_address" class="form-control" readonly >
...
<fieldset  class="field_set">
    ...
    <div class="form-group">
        <label class="col-sm-1 control-label">رقم الهوية</label>
        <div class="col-sm-2">
            <input type="text" readonly  data-val="true" value="<?php echo @$rs['D_ID'] ;?>"   placeholder="رقم قوية المدعى عليه"  data-val-required="حقل مطلوب" name="d_id" id="txt_d_id" class="form-control">
        ...
        <div class="col-sm-5">
            <input  type="text" value="<?php echo @$rs['D_NAME'] ;?>"  readonly data-val="true"  placeholder="اسم المدعى عليه" data-val-required="حقل مطلوب" name="d_name" id="txt_d_name" class="form-control" disabled>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <input  type="text" readonly data-val="true" value="<?php echo @$rs['D_TEL'] ;?>"   placeholder="رقم هاتف المدعى عليه"  data-val-required="حقل مطلوب" name="d_tel" id="txt_d_tel" class="form-control">
        ...
        <div class="col-sm-2">
            <input  type="text"  readonly data-val="true" value="<?php echo @$rs['D_MOBILE'] ;?>"   placeholder="رقم جوال المدعى عليه"  data-val-required="حقل مطلوب" name="d_mobile" id="txt_d_mobile" class="form-control">
    ...
    <div class="form-group">
        <label class="col-sm-1 control-label">العنوان</label>
        <div class="col-sm-8">
            <input  type="text" readonly data-val="true" value="<?php echo @$rs['D_ADDRESS'] ;?>"   placeholder="عنوان المدعى عليه" data-val-required="حقل مطلوب" name="d_address" id="txt_d_address" class="form-control">
...
<fieldset class="field_set"   >
    <legend >بيانات القضية الحقوقية</legend>

        <div class="form-group">
            <label class="col-sm-1 control-label">رقم القضية</label>
            <div class="col-sm-2">
                <input readonly  type="text" data-val="true" value="<?php echo @$rs['ISSUE_NO'] ;?>"  placeholder="رقم القضية"   name="exe_issue_no" id="txt_exe_issue_no" class="form-control">
            </div>
            <label class="col-sm-1 control-label"> / </label>

            <div class="col-sm-2">
                <input readonly  type="text" data-val="true" value="<?php echo @$rs['ISSUE_YEAR'] ;?>"   placeholder="سنة القضية"   name="exe_issue_year" id="txt_exe_issue_year" class="form-control">
            </div>
            <div class="col-sm-2">
<?php
...
?>
                <a href="<?=base_url("issues/issues/get_issue_info/".@$rs['SER'])?>" target="_blank"><button type="button" class="btn btn-primary">القضية الحقوقية</button></a>
<?php } else { ?>

    <a href="<?=base_url("issues/issues/get_issue_info/".@$rs_exec['SER_ISSUE_TYPE'])?>" target="_blank"><button type="button" class="btn btn-primary">القضية الحقوقية</button></a>
...
<fieldset  class="field_set">
    ...
    <div class="form-group">
        <label class="col-sm-1 control-label">رقم القضية</label>
        <div class="col-sm-2">
            <input type="text" readonly  value="<?php echo @$rs['EXE_ISSUE_NO'] ;?>"   placeholder="سنة القضية"   name="issue_no" id="txt_issue_no" class="form-control">
        </div>
        <label class="col-sm-1 control-label"> / </label>

        <div class="col-sm-2">
            <input type="text" readonly  value="<?php echo @$rs['EXE_ISSUE_YEAR'] ;?>"   placeholder="سنة القضية"   name="issue_year" id="txt_issue_year" class="form-control">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="text" data-val="true" value="<?php echo @$rs_exec['PE_ID'] ;?>"  placeholder="رقم هوية المدعي" data-val-required="حقل مطلوب" name="pe_id" id="txt_pe_id" class="form-control">
        ...
        <div class="col-sm-5">
            <input type="text" data-val="true" value="<?php echo @$rs_exec['PE_NAME'] ;?>" placeholder="اسم المدعي"  data-val-required="حقل مطلوب" name="pe_name" id="txt_pe_name" class="form-control" disabled>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="text" data-val="true" value="<?php echo @$rs_exec['FEES'] ;?>"  placeholder="رسوم ومصاريف القضية"   data-val-required="حقل مطلوب" name="fees" id="txt_fees" class="form-control">
        ...
        <div class="col-sm-2">
            <input type="text" data-val="true" value="<?php echo @$rs_exec['F_NOTES'] ;?>" placeholder="ملاحظات على الرسوم"   data-val-required="حقل مطلوب" name="f_notes" id="txt_f_notes" class="form-control">
        ...
        <div class="col-sm-2">
            <input type="text" data-val="true" value="<?php echo @$rs_exec['ISSUE_DATE'] ;?>" placeholder="تاريخ ايداع القضية" data-type="date"  data-date-format="DD/MM/YYYY"   data-val-regex="التاريخ غير صحيح!" data-val-regex-pattern="<?= date_format_exp() ?>"   data-val-required="حقل مطلوب" name="issue_date" id="txt_issue_date" class="form-control">
        ...
        <div class="col-sm-2">
            <select name="court_name" id="dp_court_name" class="form-control">
                ...
                <?php foreach($gedco_branch_issuess as $row) :?>
                    <option  value="<?= $row['CON_NO'] ?>" <?PHP if ($row['CON_NO']==((count($rs_exec)>0)?$rs_exec['COURT_NAME']:0)){ echo " selected"; } ?> ><?php echo $row['CON_NAME']  ?></option>
                <?php endforeach; ?>
            </select>
        </div>

        <div class="col-sm-2">
            <input type="hidden" value="4" name="issue_type" id="txt_issue_type">
        </div>
    </div>
...
<fieldset  class="field_set">
    ...
    <div   class="details" >
        <?php echo modules::run("$MODULE_NAME/$TB_NAME/$DET_TB_NAME1", (count($rs_exec)>0)?$rs_exec['SER']:0,((count($rs_exec)>0)? $rs_exec['ADOPT'] : '' )); ?>
...
<div <?= $hide_ins ?>  id="ins_div">
    <fieldset  class="field_set">
        ...
        <div class="details" >
            <?php echo modules::run("$MODULE_NAME/$TB_NAME/$DET_TB_NAME2", (count($rs_exec)>0)?$rs_exec['SER']:0,((count($rs_exec)>0)? $rs_exec['ADOPT'] : '' )); ?>
...
<fieldset  class="field_set">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <input type="text" value="<?php echo @$rs_exec['PAID_VALUE'] ;?>" data-val="true" placeholder="مبلغ الدفع"  data-val-required="حقل مطلوب" name="paid_value" id="txt_paid_value" class="form-control">
        ...
        <div class="col-sm-2">
            <select name="status" id="dp_status" class="form-control">
                ...
                <?php foreach($status as $row) :?>
                    <option  value="<?= $row['CON_NO'] ?>" <?PHP if ($row['CON_NO']==((count($rs_exec)>0)?$rs_exec['STATUS']:0)){ echo " selected"; } ?> ><?php echo $row['CON_NAME']  ?></option>
                <?php endforeach; ?>
            </select>
        </div>
...
<fieldset  class="field_set">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            <textarea class="form-control" name="issues_notes"   id="txt_issues_notes"style="margin: 0px 0px 0px -413.896px; width: 1555px; height: 148px;"><?php echo @$rs_exec['ISSUES_NOTES'] ;?></textarea>
        </div>
...
<div class="modal-footer">
    <?php
     if(  HaveAccess($post_url)  && ($isCreate2 || ( @$rs_exec['ADOPT']==1 ) ) AND  ( $isCreate2 || (@$rs_exec['INSERT_USER']==$this->user->id)?1 : 0 ) ||  ( $isCreate2 || (@$rs_exec['UPDATE_USER']==$this->user->id)?1 : 0 ) ) : ?>
    <button type="submit" data-action="submit" class="btn btn-primary">حفظ البيانات</button>
    <?php endif; ?>

    <?php  if ( HaveAccess($adopt_url) && (!$isCreate2 and ( (count($rs_exec)>0)? $rs_exec['ADOPT']==1 : '' ) and  ($this->user->branch == $rs_exec['ISSUE_BRANCH'] and  ( (@$rs_exec['UN_ADOPT_USER']!='')?(@$rs_exec['UN_ADOPT_USER']!=$this->user->id?1:0) : 1 )))) : ?>
        <button type="button" id="btn_adopt" onclick='javascript:return_adopt(1);' class="btn btn-success">اعتماد  </button>
    <?php  endif; ?>

    <?php  if ( HaveAccess($un_adopt_url) && (!$isCreate2 and ( (count($rs_exec)>0)? $rs_exec['ADOPT']==2 : '' ) and   (($this->user->branch == $rs_exec['ISSUE_BRANCH']) ) and   (($this->user->id != $rs_exec['ADOPT_USER'])) )) : ?>
           ...
           $.ajax({
               url: 'https://im-server.gedco.ps:8001/apis/GetData/'+$(this).val(),
				...
				if(data.DATA.length == 0){
                    ...
                    //var ADDRESS_D = obj.CI_CITY+'-'+obj.STREET_ARB;
                        $('#txt_pe_name').val('شركة توزيع الكهرباء محافظات غزة/ '+FULL_NAME);
 ...
 $('#txt_exe_pe_id').change(function(){
           $.ajax({
				...
				if(data.DATA.length == 0){
                    ...
                    var obj = $.parseJSON(data.DATA[0].length);
