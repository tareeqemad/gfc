...
class issues_model extends MY_Model{
    ...
    function get_sub_info($id){
        ...
        $result = $this->conn->excuteProcedures($this->PKG_NAME,'ISSUE_GEDCO_TB_INSERT',$params);
    ...
    function get_list($sql,$offset,$row){
        ...
        $result = $this->New_rmodel->general_get('LAW_PKG','ISSUE_GEDCO_TB_LIST',$params);
        return $result;
    }
    ...
    function get_issue($id= 0){
        ...
        $result = $this->New_rmodel->general_get('LAW_PKG','ISSUE_GEDCO_TB_GET',$params);
        return $result;
    }
    ...
    function edit($data){
        ...
        $result = $this->conn->excuteProcedures('LAW_PKG','ISSUE_GEDCO_TB_UPDATE',$params);
        return $result['MSG_OUT'];
    ...
    function adopt_info($id,$case,$table_name,$branch,$user_id){
        ...
        $result = $this->conn->excuteProcedures('LAW_PKG','ISSUE_GEDCO_TB_ADOPT',$params);
