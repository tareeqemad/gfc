...
$get_page_url = base_url("$MODULE_NAME/$TB_NAME/get_page_evaluate");
            ...
            <div class="modal-footer">
                ...
                <?php  if( HaveAccess($adopt_all_url)):  ?>
                   <!-- <button type="button" onclick="javascript:return_adopt(1);" class="btn btn-danger">اعتماد و ترحيل الخطة الشهرية</button>-->
                    <button type="button" onclick="javascript:return_adopt(1);" class="btn btn-danger">اعتماد و ترحيل التقييم</button>
