...
$TB_NAME= 'planning';
$TB_NAME1= 'planning_unit';
$create_url =base_url("$MODULE_NAME/$TB_NAME/create");
$get_url=base_url("$MODULE_NAME/$TB_NAME1/get");
if($str_plan[0]['ADOPT'] == 1 || $str_plan[0]['ADOPT'] =='')
$adopt_plan='غير معتمدة';
else
 $adopt_plan='معتمدة';
?>
<style>
...
<div class="portlet box" style="background-color: #117BC2; background-color: #24A1F5 ; font-size: 20px;">
    <div class="portlet-title">
        <div class="caption">
            ...
            <a  href="<?= $get_url.'/'.$str_plan[0]['SER']; ?>" style="color:#FFF;"><i class="glyphicon glyphicon-folder-open text-right"></i>عنوان الخطة : <?=$str_plan[0]['TITLE'].' ('.$adopt_plan.')';?></a>
            <div style="display: inline-block;position: relative;  left: -60%; /* or right 50% */ text-align: left;">
                    ...
                    <div class="panel-heading text-right">
                        <h4 class="panel-title">
                            ...
                            <!--<div style="display: inline-block; float: left;">
                                ...
                                <a  href="#" data-toggle="modal" data-target="#planningModal"><i class="glyphicon glyphicon-list-alt"></i>المحور الاستراتيجي</a>
                          </div> -->
                    ...
                    <div id="collapse_3_<?=$row['ID'];?>" class="panel-collapse collapse">
                        <div class="panel-body">
                            ...
                            <div class="panel-group" style="margin-right:10px; "id="accordion_objective">
                                <?php
                                $goal_list=modules::run("$MODULE_NAME/$TB_NAME1/public_get_goal_p",$row['ID']);
                                        ...
                                        <div id="collapse_goal_<?=$row2['ID'];?>" class="panel-collapse collapse">
                                            <div class="panel-body">
                                                <div class="panel-group" style="margin-right:15px; "id="accordion_goal">
                                                    <?php
                                                    $goal_t_list=modules::run("$MODULE_NAME/$TB_NAME1/public_get_goal_p",$row2['ID']);
