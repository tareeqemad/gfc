...
<?php if(count($details) <= 0) {  // ادخال ?>
    <tr>
        <td>
            <select name="planning_dir[]"  data-val ="false"   data-val-required="حقل مطلوب"  id="dp_planning_dir_<?=$count_activity?>" class="form-control">
                <option></option>
        ...
        <td>
            <select name="branch[]"  data-val ="false"   data-val-required="حقل مطلوب"  id="dp_branch_<?=$count_activity?>" class="form-control">
                <option></option>
        ...
        <td>
            <select name="manage_id[]"  data-val ="false"   data-val-required="حقل مطلوب"  id="dp_manage_id_<?= $count_activity ?>" class="form-control">
                <option></option>
        ...
        <td>
            <select name="cycle_id[]"  data-val ="false"   data-val-required="حقل مطلوب"  id="dp_cycle_id_<?= $count_activity ?>" class="form-control">
                <option></option>
        ...
        <td>
            <input class="form-control" name="activity_name[]" id="txt_activity_name_<?=$count_activity?>"  data-val ="false"   data-val-required="حقل مطلوب"  />
            <!--<span class="field-validation-valid" data-valmsg-for="activity_name[]" data-valmsg-replace="true"></span>-->

        </td>
        <td>

            <select name="main_from_month[]" id="dp_main_from_month_<?=$count_activity?>" data-curr="false" class="form-control"  data-val ="false"   data-val-required="حقل مطلوب" >
                <option  value="">-</option>
                <?php for($i = 1; $i <= 12 ;$i++) :?>
        ...
        <td>
            ...
            <select name="main_to_month[]" id="dp_main_to_month_<?=$count_activity?>" data-curr="false" class="form-control"  data-val ="false"   data-val-required="حقل مطلوب" >
                <option  value="">-</option>
                <?php for($i = 1; $i <= 12 ;$i++) :?>
                    <option value="<?= $i ?>"><?= months($i) ?></option>
                <?php endfor; ?>
        ...
        <td>
            <input class="form-control" name="weight[]" id="txt_weight_<?=$count_activity?>"  data-val ="false"   data-val-required="حقل مطلوب"  />
...
<?php
    ...
    foreach($details as $row) {
        ...
        <tr>
            ...
            <td>
                 <input class="form-control" name="activity_name[]" id="txt_activity_name_<?=$count_activity?>"  value="<?=$row['ACTIVITY_NAME']?>"  data-val ="false"   data-val-required="حقل مطلوب"  />
            ...
            <td>
                <input class="form-control" name="weight[]" id="txt_weight_<?=$count_activity?>" value="<?=$row['WEIGHT']?>"  data-val ="false"   data-val-required="حقل مطلوب"  />
                <!-- <span class="field-validation-valid" data-valmsg-for="weight[]" data-valmsg-replace="true"></span>-->
            </td>
