...
class Receipt_batun_detail_model extends MY_Model
{

    var $PKG_NAME = "LOGISTIC_ITEMS_PKG";
    var $TABLE_NAME = 'RECEIPT_BATUN_DET';
    ...
    function get_adopt($id = 0)
    {
        ...
        $params = array(array('name' => ':SER_ADOPT_IN', 'value' => $id, 'type' => SQLT_INT, 'length' => -1),
            array('name' => ':REF_CUR_OUT', 'value' => 'cursor', 'type' => OCI_B_CURSOR),
            array('name' => ':MSG_OUT', 'value' => 'MSG_OUT', 'type' => SQLT_CHR, 'length' => 500));
        $result = $this->New_rmodel->general_get($this->PKG_NAME,'RECEIPT_BATUN_DADOPT_GET', $params);
