...
class Receipt_logistical_group_model extends MY_Model
{

    var $PKG_NAME = "LOGISTIC_ITEMS_PKG";
    var $TABLE_NAME = 'RECEIPT_LOGISTIC_GROUP';
    ...
    function member_record($id,$committees_id,$member_note)
    {
        ...
        $result = $this->conn->excuteProcedures($this->PKG_NAME,'L_RECEIPT_CLASS_INPUT_COMMTIEE', $params);
        return $result['MSG_OUT'];
    }
    ...
    function get_committee_emails($id)
    {
        ...
        $result = $this->New_rmodel->general_get($this->PKG_NAME, 'RECIPT_COMMITTE_EMAILS_GET_L', $params);
        return $result;
    }
}