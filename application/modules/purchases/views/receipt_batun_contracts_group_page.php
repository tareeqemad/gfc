...
?>
<input type="hidden" value="<?= $record_member_url ?>" id="record_member_url">
...
<script>
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////
    function Receipt_batun_contracts_memebers_record(obj){
        var record_member_url = $('#record_member_url').val();
        if(confirm('هل تريد إتمام العملية ؟')){
            var tbl = '#Receipt_logistical_contracts_tb';
