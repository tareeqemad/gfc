...
$adopt_url= base_url("$MODULE_NAME/$TB_NAME/c_adopt");
            ...
            <div class="modal-body inline_form">
                ...
                <fieldset>
                    ...
                    <div class="form-group col-sm-3">
                        ...
                        <div>
                            <input type="text" name="purchase_class_name" value="<?php echo $rs['PURCHASE_CLASS_NAME'] ;?>" readonly   data-type="text"   id="txt_purchase_class_name" class="form-control " data-val="true" data-val-required="حقل مطلوب" >
                        </div>
                    </div>
                    <div style="clear: both;">
                        <div class="form-group col-sm-4">
                            ...
                            <div>
                                <textarea class="form-control" name="purchase_notes" readonly rows="5" id="txt_purchase_notes" data-type="text"  data-val="true" data-val-required="حقل مطلوب"><?php echo $rs['PURCHASE_NOTES'] ;?></textarea>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group col-sm-1">
                                ...
                                <div>
                                    <input type="text" name="purchase_price1" value="<?php echo $rs['PURCHASE_PRICE1'];  ?>"  readonly  data-type="text"   id="txt_purchase_price1" class="form-control " data-val="true" data-val-required="حقل مطلوب"  >
                                </div>
                            </div>
                            <div class="form-group col-sm-1">
                                <label class="control-label">سعر2</label>
                                <div>
                                    <input type="text" name="purchase_price2" value="<?php echo $rs['PURCHASE_PRICE2'];  ?>"  readonly  data-type="text"   id="txt_purchase_price2" class="form-control " data-val="true" data-val-required="حقل مطلوب"  >
                                </div>
                            </div>
                            <div class="form-group col-sm-1">
                                <label class="control-label">سعر3</label>
                                <div>
                                    <input type="text" name="purchase_price3" value="<?php echo $rs['PURCHASE_PRICE3']; ?>"   readonly data-type="text"   id="txt_purchase_price3" class="form-control " data-val="true" data-val-required="حقل مطلوب"  >
                                </div>
                            </div>
                            ...
                            <div class="form-group col-sm-1">
                                ...
                                <div>
                                    <input type="text" name="avarage_prices"  value="<?php echo $rs['AVG_PRICE']; ?>"  readonly   data-type="text"   id="txt_avarage_prices" class="form-control " >
                                </div>
                            </div>
                ...
                <fieldset>
                    ...
                    <div class="form-group col-sm-1">
                        ...
                        <div>
                            <input class="form-control" type="text" name="class_id" id="h_txt_class_id" value="<?php echo (count($rs)>0)? $rs['CLASS_ID']: '' ;?>" data-val="true" data-val-required="حقل مطلوب"  >
                    ...
                    <div class="form-group col-sm-1">
                        ...
                        <div>
                            <input readonly class="form-control"  name="price" id="price_txt_class_id" value="<?php echo (count($rs)>0)? $rs['CLASS_PURCHASING']: '' ;?>" />
                        </div>
                    </div>
...
<hr/>
                <div class="modal-footer">
                    ...
                    if (  HaveAccess($post_url) && ($isCreate || ( $rs['ADOPT']==3 ) )  ) : ?>
                    ...
                    <?php if ( HaveAccess($adopt_url) && (!$isCreate and ( (count($rs)>0)? $rs['ADOPT']==3 : '' ))  and ( (count($rs)>0)? $rs['CLASS_ID'] : '' )) : ?>
                        <button type="button" id="btn_adopt" onclick='javascript:return_adopt(3);' class="btn btn-success">اعتماد</button>
                    <?php endif; ?>
...
$("#txt_class_unit").val(item.UNIT_NAME);
$("#txt_price").val(item.CLASS_PURCHASING);
$("#h_class_unit").val(item.CLASS_UNIT_SUB);
$("#txt_exp_account_cust").val(item.EXP_ACCOUNT_CUST);
$("#txt_exp_account_cust_name").val(item.EXP_ACCOUNT_CUST_NAME);
$("#txt_destruction_type").val(item.DESTRUCTION_TYPE_NAME);
$("#h_destruction_type").val(item.DESTRUCTION_TYPE);
$("#txt_destruction_percent").val(item.DESTRUCTION_PERCENT);
$("#txt_destruction_account_id").val(item.DESTRUCTION_ACCOUNT_ID);
$("#txt_destruction_account_name").val(item.DESTRUCTION_ACCOUNT_ID_NAME);
$("#txt_average_life_span").val(item.AVERAGE_LIFE_SPAN);
$("#txt_average_life_span_type").val(item.AVERAGE_LIFE_SPAN_TYPE_NAME);
$("#h_average_life_span_type").val(item.AVERAGE_LIFE_SPAN_TYPE);
                 ...
                 $("#txt_exp_account_cust_name").val('');
                 $("#txt_destruction_type").val('');
                 $("#h_destruction_type").val('');
                 $("#txt_destruction_percent").val('');
                 $("#txt_destruction_account_id").val('');
                 $("#txt_destruction_account_name").val(item.DESTRUCTION_ACCOUNT_ID_NAME);
                 $("#txt_average_life_span").val(item.AVERAGE_LIFE_SPAN);
                 $("#txt_average_life_span_type").val('');
                 $("#h_average_life_span_type").val('');
                }
         });
    });
