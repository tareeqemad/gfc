...
$project_accounts_url = base_url('projects/projects/public_select_civil_project_accounts');//base_url('projects/projects/public_select_project_accounts');projects_account_civil_select
        ...
        <div id="container">
            ...
            <form class="form-vertical" id="<?= $TB_NAME ?>_form" method="post" action="<?= $post_url ?>" role="form"
                ...
                <div class="modal-body inline_form">
                    <fieldset>
                        ...
                        <div class="row">
                          ...
                          <div class="form-group col-sm-2">
                                ...
                                <div class="">
                                    <select name="customer_type" id="dp_customer_type" class="form-control sel2">
                                        <?php foreach ($account_type as $row_type) :
                                            if($row_type['CON_NO']==3){
                                            ?>
                                            <option value="<?= $row_type['CON_NO'] ?>" <?= $HaveRs ? ($rs['CUSTOMER_TYPE'] == $row_type['CON_NO'] ? 'selected' : '') : '' ?>><?= $row_type['CON_NAME'] ?></option>
                                            <?php }?>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group col-sm-2">
                                ...
                                <div class="">
                                    <input name="civil_customer_accounts_name" data-val="true" readonly data-val-required="حقل مطلوب"
                                           class="form-control" readonly id="txt_civil_customer_accounts_name" value="<?= $HaveRs ? $rs['P_CUSTOMER_ID_NAME'] : '' ?>">
                                    <input type="hidden" name="h_civil_customer_accounts_name" value="<?= $HaveRs ? $rs['CUSTOMER_ID'] : '' ?>" id="h_civil_customer_accounts_name">
                    ...
                    if ($HaveRs) {
                        ...
                        <fieldset>
                            ...
                            <?php
                            echo modules::run('attachments/attachment/index', $rs['RECEIPT_CLASS_INPUT_ID'], 'RECEIPT_CIVIL_CONTRACTS_TB');
                            ?>
                ...
                <div class="modal-footer">
                    ...
                    if (HaveAccess($adopt_url . '30') and  $rs['ADOPT'] == 20) : ?>
...
////////////////////////////////////////////////    
 ...
 ////////////////////////////////////////////////////////////////////////////////////////////
  $('#txt_civil_customer_accounts_name').click(function(e){
      selectAccount($(this), 3);
    });   
 /////////////////////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////
function Receipt_civil_contracts_memebers_record(obj){
 if(confirm('هل تريد إتمام العملية ؟')){ 
    var tbl = '#{$TB_NAME}_tb';
    var container = $('#' + $(tbl).attr('data-container'));
 ...
 reBind(1);
    ...
    function selectAccount(obj, _type) {
        ...
        if (_type == 3)
            _showReport(project_accounts_url + '/' + num + '/');
        if (_type == 5)
            _showReport(customer_url + '/' + $(obj).attr('id') + '/4');
    }
    ///////////////////////////////////////////////
    var btn_1= '';
    $('.btn_adopt_class').click( function(){
      btn_1 = $(this);
    });
    /////////////////////////////////////////////////////
        function adopt_(no){
        ...
        if(confirm(msg)){
            ...
            get_data('{$adopt_url}'+no, values, function(ret){
                if(!isNaN(ret)){
                    ...
                    $('button').attr('disabled','disabled');
                        var sub= ' اعتماد محضر الفحص و الاستلام للأعمال المدنية رقم '+'{$ser}';
                        var text= 'يرجى اعتماد محضر الفحص و الاستلام للأعمال المدنية رقم '+'{$ser}';
                        text+= '<br>للاطلاع افتح الرابط';
                        text+= ' <br>{$gfc_domain}{$get_url}/{$ser} ';
                        ...
                        if(no=='30' || no=='40' || no=='50')
                            {
                                 ...
                                 _send_mail(btn_1,'{$next_adopt_email}',sub,text);
                            }
                        if(no=='_20' || no=='_30' || no=='_40')
                            {
                               
                                sub=sub+" (مرجع) "
                                 _send_mail(btn_1,'{$prev_adopt_email}',sub,text);
                            }
