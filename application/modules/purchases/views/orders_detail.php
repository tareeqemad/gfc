    ...
    <table class="table" id="orders_detailTbl" data-container="container">
        ...
        <?php if (count($rec_details) <= 0) : ?>
            <tr>
                ...
                <td>
                    ...
                    <!-- <input  type="text" name="h_class_id[]" data-val="true" id="h_class_id_<?= $count ?>"  class="form-control">-->
                ...
                <td>
                    <input type="hidden" data-val="true" name="unit_class_id[]" class="form-control"
                           id="unit_class_id_<?= $count ?>" class="form-control col-sm-2"/>
                ...
                <td>
                    <!--<input name="approved_amount[]"   id="approved_amount_<?= $count ?>" type="text" class="form-control" > --></td>

                <td>
                    <!--<input name="customer_price[]"    id="customer_price_<?= $count ?>"   data-val-required="حقل مطلوب"   data-val-regex="المدخل غير صحيح!"   class="form-control">-->

                </td>
                <td>
                    <!--<input readonly name="total_customer_price[]"    id="total_customer_price_<?= $count ?>"   data-val-required="حقل مطلوب"   data-val-regex="المدخل غير صحيح!"   class="form-control">-->

                </td>
                <td>
                    <!--<input name="price[]"     id="price_<?= $count ?>"   data-val-required="حقل مطلوب"   data-val-regex="المدخل غير صحيح!"   class="form-control">-->

                </td>
                <td>
                    <!--<input readonly name="total_price[]"    id="total_price_<?= $count ?>"   data-val-required="حقل مطلوب"   data-val-regex="المدخل غير صحيح!"   class="form-control">-->
        ...
        <?php foreach ($rec_details as $row) : ?>
            ...
            <tr>
                ...
                <td>
                    <input type="hidden" name="h_class_id[]" data-val="true" id="h_class_id_<?= $count ?>"
                           value="<?= $row['CLASS_ID'] ?>" class="form-control col-sm-2">
                    <?= $row['CLASS_ID'] ?></td>
                <td>

                    <?= $row['CLASS_ID_NAME'] ?> </td>
                <td>
                    <input type="hidden" data-val="true" name="unit_class_id[]" value="<?= $row['CLASS_UNIT'] ?>"
                           class="form-control" id="unit_class_id_<?= $count ?>" class="form-control col-sm-2"/>
                ...
                <td><input name="customer_price[]" id="customer_price_<?= $count ?>" class="form-control"
                           value="<?= isset($row['CUSTOMER_PRICE']) ? $row['CUSTOMER_PRICE'] : '' ?>">

                </td>
                <td><input readonly name="total_customer_price[]" id="total_customer_price_<?= $count ?>"
                           data-val-required="حقل مطلوب" data-val-regex="المدخل غير صحيح!" class="form-control">

                <td><input name="price[]" id="price_<?= $count ?>" class="form-control"
                           value="<?= isset($row['ORDER_PRICE']) ? $row['ORDER_PRICE'] : '' ?>">

                </td>
                <td><input readonly name="total_price[]" id="total_price_<?= $count ?>" data-val-required="حقل مطلوب"
                           data-val-regex="المدخل غير صحيح!" class="form-control">

                <td>
                    <input type="text" name="order_date[]" id="order_date_<?= $count ?>"
                           value="<?= $row['ORDER_DATE'] ?>" class="form-control col-sm-2" data-type="date"
                    ...
                    <span class="field-validation-valid" data-valmsg-for="order_date[]"
                          data-valmsg-replace="true"></span>

                </td>
                <td>
                    <textarea rows="2" name="note[]" id="note_<?= $count ?>"
