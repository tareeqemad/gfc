...
class vacation_request_model extends MY_Model{
    var $PKG_NAME= "HR_ATTENDANCE_PKG";
    var $TABLE_NAME= 'VACATION_REQUEST_TB';
    ...
    function get_balance($emp= 0, $vac_year=''){
        
        $params =array(
            array('name'=>':EMP','value'=>$emp ,'type'=>'','length'=>-1),
            array('name'=>':YEAR','value'=>$vac_year ,'type'=>'','length'=>-1),
            array('name'=>':REF_CUR_OUT','value'=>'cursor','type'=>OCI_B_CURSOR),
            array('name'=>':MSG_OUT','value'=>'MSG_OUT','type'=>'','length'=>500)
        );
    ...
    function adopt($id, $case, $note= ''){
        $params =array(
            ...
            array('name'=>':REFUSAL_NOTE','value'=>$note,'type'=>'','length'=>-1),
            array('name'=>':MSG_OUT','value'=>'MSG_OUT','type'=>'','length'=>500)
        );
