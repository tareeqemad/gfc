    ...
    <div class="form-body">
        ...
        <form class="form-vertical" id="<?=$TB_NAME?>_form" >
            <div class="modal-body inline_form">
                ...
                <div class="form-group col-sm-1">
                    <label class="control-label">من سنة</label>
                    <div>
                        <input type="text" name="year_from" id="txt_year_from" class="form-control">
                    </div>
                </div>

                <div class="form-group col-sm-1">
                    <label class="control-label">لسنة</label>
                    <div>
                        <input type="text" name="year_to" id="txt_year_to" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group col-sm-1">
                    ...
                    <div>
                        <input type="text" name="balance_val" id="txt_balance_val" class="form-control">
                    </div>
                </div>
        ...
        <div id="container">
            <?=modules::run($get_page_url, $page, $ser, $emp_no, $vac_type, $year_from, $year_to, $balance_val, $adopt );?>
        </div>
...
<script>
    ...
    function values_search(add_page){
        var values= {page:1, ser:$('#txt_ser').val(), emp_no:$('#dp_emp_no').val(), vac_type:-1, year_from:$('#txt_year_from').val(), year_to:$('#txt_year_to').val(), balance_val:$('#txt_balance_val').val(), adopt:$('#dp_adopt').val() };
        if(add_page==0)
            delete values.page;
        return values;
    }
