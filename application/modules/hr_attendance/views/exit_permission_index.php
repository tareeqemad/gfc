    ...
    <div class="form-body">
        ...
        <form class="form-vertical" id="<?=$TB_NAME?>_form" >
            <div class="modal-body inline_form">
                ...
                <div class="form-group col-sm-2">
                    <label class="control-label">تاريخ الاذن من</label>
                    <div>
                        <input type="text" <?=$date_attr?> name="p_date" id="txt_p_date" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group col-sm-2">
                    ...
                    <div>
                        <input type="text" <?=$date_attr?> name="p_date_2" id="txt_p_date_2" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group col-sm-1">
                    ...
                    <div>
                        <input type="text" name="perm_year" id="txt_perm_year" value="<?=($perm_year!=-1)?$perm_year:''?>" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <div>
                        <input type="text" name="notes_emp" id="txt_notes_emp" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <div>
                        <input type="text" name="notes_observer" id="txt_notes_observer" class="form-control">
                    </div>
                </div>
        ...
        <div id="container">
            <?=modules::run($get_page_url, $page, $page_act, $ser, $emp_no, $p_date, $p_date_2, $notes_emp, $notes_observer, $adopt, $permi_type, $perm_year, $entry_user, $branch_id, $not_closed );?>
        </div>
...
<script>
    ...
    function values_search(add_page){
        var values= {page:1, page_act: '{$page_act}', ser:$('#txt_ser').val(), emp_no:$('#dp_emp_no').val(), p_date:$('#txt_p_date').val(), p_date_2:$('#txt_p_date_2').val(), notes_emp:$('#txt_notes_emp').val(), notes_observer:$('#txt_notes_observer').val(), adopt:$('#dp_adopt').val(), permi_type:$('#dp_permi_type').val(), perm_year:$('#txt_perm_year').val(), entry_user:$('#dp_entry_user').val(), branch_id:$('#dp_branch_id').val(), not_closed:$('#dp_not_closed').val() };
        if(add_page==0)
            delete values.page;
        return values;
    }
