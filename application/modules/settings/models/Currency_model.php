...
class currency_model extends MY_Model{
    ...
    function get($id= 0){
        ...
        $params =array(
            array('name'=>':CURR_ID','value'=>$id ,'type'=>SQLT_INT,'length'=>-1),
    ...
    function get_all_date($date){
        ...
        $result = $this->New_rmodel->general_get($this->PKG_NAME, 'CURRENCY_TB_GET_ALL_DATE',$params);
        return $result;
    }
    ...
    function delete($id){
        $params =array(
            array('name'=>':CURR_ID_in','value'=>$id,'type'=>'','length'=>-1),
            array('name'=>':MSG_OUT','value'=>'MSG_OUT','type'=>SQLT_CHR,'length'=>-1),
        );
