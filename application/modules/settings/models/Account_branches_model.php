...
class Account_branches_model extends MY_Model{
    var $PKG_NAME= "FINANCIAL_PKG";
    var $TABLE_NAME= 'ACCOUNT_BRANCHES_TB';
    ...
    function get_list($id= 0){
        ...
        $params =array(
            array('name'=>':BRANCHES_IN','value'=>$id ,'type'=>SQLT_INT,'length'=>-1),
    ...
    function delete($id){
        $params =array(
            array('name'=>':BRANCHES_IN','value'=>$id,'type'=>'','length'=>-1),
            array('name'=>':MSG_OUT','value'=>'MSG_OUT','type'=>SQLT_CHR,'length'=>-1),
        );
