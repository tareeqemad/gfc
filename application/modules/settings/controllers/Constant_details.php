...
class constant_details extends MY_Controller{

    var $MODEL_NAME= 'constant_details_model';
    var $PAGE_URL= 'settings/constant_details/get_page';
    ...
    function get_page(){
        ...
        $this->load->view('constant_details_page',$data);
    }
