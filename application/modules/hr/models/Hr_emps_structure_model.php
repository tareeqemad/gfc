...
class hr_emps_structure_model extends MY_Model{
    var $PKG_NAME= "HR_PKG";
    var $TABLE_NAME= 'HR_EMPS_STRUCTURE_TB';
    ...
    function edit_emp($ser,$job_id,$supervision,$alternative_manager_no,$open_assigning_work){
        $params =array(
            array('name'=>':SER','value'=>$ser,'type'=>'','length'=>-1),
            ...
            array('name'=>':OPEN_ASSIGNING_WORK','value'=>$open_assigning_work,'type'=>'','length'=>-1),
            array('name'=>':MSG_OUT','value'=>'MSG_OUT','type'=>SQLT_CHR,'length'=>500),
        );
