...
<div class="row">
    ...
    <div class="form-body">
        <form class="form-vertical" id="<?=$TB_NAME?>_form" >
            <div class="modal-body inline_form">
                ...
                <div class="form-group col-sm-3">
                    ...
                    <div>
                        <select name="admin_id" id="dp_admin_id" class="form-control" >
                            <option value=""></option>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <div>
                        <select name="dept_manager_no" id="dp_dept_manager_no" class="form-control" >
                            <option value=""></option>
                ...
                <div class="form-group col-sm-3">
                    ...
                    <div>
                        <select name="dept_id" id="dp_dept_id" class="form-control" >
                            <option value=""></option>
        ...
        <div id="container">
            <?=modules::run($get_page_url, $page, $evaluation_order_id, $admin_id, $dept_manager_no, $dept_id);?>
        </div>
...
<script>
    ...
    $(document).ready(function() {
		$('#dp_evaluation_order_id, #dp_admin_id, #dp_dept_manager_no, #dp_dept_id').select2();
    });
    ...
    function clear_form(){
        $('#dp_evaluation_order_id, #dp_admin_id, #dp_dept_manager_no, #dp_dept_id').select2('val','');
    ...
    function search(){
        var values= {page:1, evaluation_order_id:$('#dp_evaluation_order_id').val(), admin_id:$('#dp_admin_id').val(), dept_manager_no:$('#dp_dept_manager_no').val(), dept_id:$('#dp_dept_id').val()};
    ...
    function LoadingData(){
        var values= {evaluation_order_id:$('#dp_evaluation_order_id').val(), admin_id:$('#dp_admin_id').val(), dept_manager_no:$('#dp_dept_manager_no').val(), dept_id:$('#dp_dept_id').val()};
