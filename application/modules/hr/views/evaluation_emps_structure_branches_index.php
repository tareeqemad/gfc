...
$MODULE_NAME= 'hr';
$TB_NAME= 'emps_structure_tree_branches';
...
<div class="row">
    <div class="toolbar">
        ...
        <ul>
            <?php if(0 and HaveAccess($create_url)): ?> <li><a onclick="javascript:emp_create();" href="javascript:;"><i class="glyphicon glyphicon-plus"></i>اضافة مرؤوس </a> </li> <?php endif;?>
            ...
            <?php if(0 and HaveAccess($delete_url)): ?><li><a  onclick="javascript:emp_delete();" href="javascript:;"><i class="glyphicon glyphicon-remove"></i>حذف </a> </li> <?php endif;?>
            <?php if(0 and HaveAccess($eval_emps_start_url) and HaveAccess($eval_emps_url)): ?><li><a onclick="javascript:eval_emps();" href="javascript:;"><i class="glyphicon glyphicon-tasks"></i> شاشة التقييم للمدير </a> </li> <?php endif;?>
