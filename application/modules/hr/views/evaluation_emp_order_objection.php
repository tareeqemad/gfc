 ...
 */ 
 ...
 $get_page_url = base_url("$MODULE_NAME/$TB_NAME/get_objection");
...
<div class="row">
    ...
    <form class="form-vertical" id="<?=$TB_NAME?>_form">
        ...
        <div class="modal-footer">
         ...
         <div id="container">
              <?=modules::run($get_page_url,$EVALUATION_ORDER_SERIAL, $EMP_NO_NAME, $EMP_MANAGER_ID_NAME, $EVALUATION_ORDER_ID, $EVAL_FORM);?>
         </div>
    </div>
</div>
<?php	
...
<script type="text/javascript">
	...
	function show_rows_details(id){
        get_to_link('{$get_url}/'+id+'/obj');
    }
	function search(){
        ...
        var values= {EVALUATION_ORDER_SERIAL, EMP_NO_NAME,EMP_MANAGER_ID_NAME, EVALUATION_ORDER_ID, EVAL_FORM};
    ...
    function print_report(evaluation_order_serial,grandson_order_serial,evaluation_order_id,emp_no){
        _showReport('{$report_url}&type=pdf&report=Hr_Emp_Obj_Gr&p_serial='+evaluation_order_serial+'&p_serial_2='+grandson_order_serial+'&p_order_id='+evaluation_order_id+'&p_emp_no='+emp_no+'&sn={$report_sn}',true);
    }
</script>
