...
$delete_url =base_url('financial/accounts/delete');
$get_url =base_url('financial/accounts/get_id');
$edit_url =base_url('financial/accounts/edit');
$create_url =base_url('financial/accounts/create');
$adapt_url =base_url('financial/accounts/update_adapt');
        ...
        <div class="modal-content _750">
            ...
            <form class="form-horizontal" id="account_from" method="post" action="<?=base_url('financial/accounts/create')?>" role="form" novalidate="novalidate">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">حساب الأب</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">رقم الحساب</label>
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">نوع الحساب </label>
                        <div class="col-sm-9">
                            <div class="radio">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">العملة</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">تبعية الحساب</label>
                        <div class="col-sm-3">
                        ...
                        <label class="col-sm-2 control-label">التدفق النقدي</label>
                        <div class="col-sm-3">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label"> المركز المالي</label>
                        <div class="col-sm-9">
                            <input type="text"  name="financial_center_id" id="txt_financial_center_id" class="form-control easyui-combotree" data-options="url:'<?= base_url('financial/financial_center/public_get_financial_center_json')?>',method:'get',animate:true,lines:true,required:true">

                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-sm-2 control-label">رقم الاصيل</label>
                        <div class="col-sm-3">
                            <input type="text" data-val="false"  data-val-required="حقل مطلوب" name="assel_no" id="txt_assel_no" class="form-control">
                            <span class="field-validation-valid" data-valmsg-for="assel_no" data-valmsg-replace="true"></span>
                        </div>
                        <label class="control-label col-sm-2"> الفرع</label>
                        <div  class="col-sm-4">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">حالة الحساب   </label>
                        <div class="col-sm-3">
    ...
    function account_get(id){
        ...
        get_data('{$get_url}',{id:id},function(data){
            ...
            $.each(data, function(i,item){
                ...
                $('#txt_assel_no').val(item.ASSEL_NO);
                $('#dp_branch').val(item.BRANCH);
                $('#dp_status').val(item.STATUS);
                        $('#txt_financial_center_id').combotree('setValue', item.FINANCIAL_CENTER_ID);
                     $('#txt_financial_center_id').combotree('setText', $('.tree-title[data-id="'+item.FINANCIAL_CENTER_ID+'"]').text());
    ...
    $('button[data-action="submit"]').click(function(e){
        ...
        ajax_insert_update(form,function(data){
            ...
            if(isCreate){
                ...
                $.fn.tree.add(obj.id+':'+(form.find('input[name="acount_name"]').val()),obj.id,"javascript:account_get('"+obj.id+"');");
