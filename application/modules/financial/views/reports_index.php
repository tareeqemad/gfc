...
<div class="row">
    ...
    <div class="form-body">
                                ...
                                <div class="form-group rp_prm" id="m_report" style="display: none;">
                                    ...
                                    <div class="col-sm-7">
                                        <select class="form-control" id="dp_m_report">
                                            ...
                                            <option value="9">ميزان المراجعة بالأرصدة و المجاميع xls</option>
                                            <option value="4">ميزان مراجعه الحسابات وتوابعها بالمجاميع</option>
                                            <option value="5">ميزان المراجعة للحسابات الاساسية</option>
                                            <option value="10">ميزان المراجعة للحسابات الاساسية xls</option>
        ...
        <div class="modal-footer">
            <button type="button" onclick="javascript:showReport('pdf');" class="btn btn-success">PDF عرض التقرير</button>

            <button type="button" onclick="javascript:showReport('xls');" class="btn btn-success">XLS عرض التقرير</button>
...
function showReport(type){
    ...
    var url = '$report_jasper_url';
    var user_branch={$this->user->branch};

    if(val == 1)
    {

        url = url + 'report_type='+type+'&report=financial_book_chains&p_account_id='+$('#h_txt_account1').val()+'&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_to_account_id='+$('#h_txt_account2').val()+'&p_branches='+$('#dp_branch').val()+'&p_username={$this->user->id}&p_source='+$('#dp_fin_source').val();
     
    }
    else if(val == 2)
    {
  
       url = url + 'report_type='+type+'&report=financial_book_chains_all&p_account_id='+$('#h_txt_account1').val()+'&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_to_account_id='+$('#h_txt_account2').val()+'&p_branches='+$('#dp_branch').val()+'&p_username={$this->user->id}&p_source='+$('#dp_fin_source').val();
    ...
    else if(val == 3)
    {
        ...
        else
        {
            ...
            url = url + 'report_type='+type+'&report=financial_book_chains&p_account_id='+$('#h_txt_account1').val()+'&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_to_account_id='+$('#h_txt_account2').val()+'&p_branches='+$('#dp_branch').val()+'&p_curr_id='+$('#dp_currency').val()+'&p_currtype=1&p_username={$this->user->id}&p_source='+$('#dp_fin_source').val();
    ...
    else if(val == 4)
    {
        ...
        else
        {
            ...
            url = url + 'report_type='+type+'&report=financial_book_chains_all&p_account_id='+$('#h_txt_account1').val()+'&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_to_account_id='+$('#h_txt_account2').val()+'&p_branches='+$('#dp_branch').val()+'&p_curr_id='+$('#dp_currency').val()+'&p_currtype=1&p_username={$this->user->id}&p_source='+$('#dp_fin_source').val();
    ...
    else if(val == 23)
    {
        ...
        else
        {
            ...
            url = url + 'report_type='+type+'&report=financial_book_chains&p_account_id='+$('#h_txt_account1').val()+'&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_to_account_id='+$('#h_txt_account2').val()+'&p_branches='+$('#dp_branch').val()+'&p_curr_id='+$('#dp_currency').val()+'&p_currtype=2&p_username={$this->user->id}&p_source='+$('#dp_fin_source').val();
    ...
    else if(val == 24)
    {
        ...
        else
        {
            ...
            url = url + 'report_type='+type+'&report=financial_book_chains_all&p_account_id='+$('#h_txt_account1').val()+'&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_to_account_id='+$('#h_txt_account2').val()+'&p_branches='+$('#dp_branch').val()+'&p_curr_id='+$('#dp_currency').val()+'&p_currtype=2&p_username={$this->user->id}&p_source='+$('#dp_fin_source').val();
    ...
    else  if(val == 5)
    {
        ...
        url = url + 'report_type='+type+'&report=financial_book_parent_rep&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_acount_parent='+$('#h_txt_parent').val()+'&p_branches='+$('#dp_branch').val()+'&p_curr_id=&p_currtype=1&p_username={$this->user->id}';
    ...
    else  if(val == 6)
    {
        ...
        url = url + 'report_type='+type+'&report=financial_book_parent_all&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_acount_parent='+$('#h_txt_parent').val()+'&p_branches='+$('#dp_branch').val()+'&p_curr_id=&p_currtype=1&p_username={$this->user->id}';
    ...
    else  if(val == 7)
    {
        ...
        else
        {
            ...
            url = url + 'report_type='+type+'&report=financial_book_parent_rep&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_acount_parent='+$('#h_txt_parent').val()+'&p_branches='+$('#dp_branch').val()+'&p_curr_id='+$('#dp_currency').val()+'&p_currtype=3&p_username={$this->user->id}';
    ...
    else  if(val == 8)
    {
        ...
        else
        {
            ...
            url = url + 'report_type='+type+'&report=financial_book_parent_all&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_acount_parent='+$('#h_txt_parent').val()+'&p_branches='+$('#dp_branch').val()+'&p_curr_id='+$('#dp_currency').val()+'&p_currtype=3&p_username={$this->user->id}';
    ...
    else  if(val == 25)
    {
        ...
        else
        {
            ...
            url = url + 'report_type='+type+'&report=financial_book_parent_rep&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_acount_parent='+$('#h_txt_parent').val()+'&p_branches='+$('#dp_branch').val()+'&p_curr_id='+$('#dp_currency').val()+'&p_currtype=2&p_username={$this->user->id}';
    ...
    else  if(val == 26)
    {
        ...
        else
        {
            ...
            url = url + 'report_type='+type+'&report=financial_book_parent_all&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_acount_parent='+$('#h_txt_parent').val()+'&p_branches='+$('#dp_branch').val()+'&p_curr_id='+$('#dp_currency').val()+'&p_currtype=2&p_username={$this->user->id}';
    ...
    else  if(val == 9)
    {
        ...
        url = url + 'report_type='+type+'&report=account_name_sum&p_account_id='+$('#h_txt_account1').val()+'&p_to_account_id='+$('#h_txt_account2').val()+'&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_branches='+$('#dp_branch').val()+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency_2').val()+'&p_fin_center='+$('#txt_financial_center_id').val()+'&p_curr_id_2='+$('#dp_currency_1').val()+'&p_chapter='+$('#dp_chapters').val();
    ...
    else  if(val == 10)
    {
        ...
        url = url + 'report_type='+type+'&report=account_name_rased&p_account_id='+$('#h_txt_account1').val()+'&p_to_account_id='+$('#h_txt_account2').val()+'&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_branches='+$('#dp_branch').val()+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency_2').val()+'&p_fin_center='+$('#txt_financial_center_id').val()+'&p_curr_id_2='+$('#dp_currency_1').val()+'&p_chapter='+$('#dp_chapters').val();
    ...
    else  if(val == 11)
    {
        ...
        url = url + 'report_type='+type+'&report=account_name_sum_rased&p_account_id='+$('#h_txt_account1').val()+'&p_to_account_id='+$('#h_txt_account2').val()+'&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_branches='+$('#dp_branch').val()+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency_2').val()+'&p_fin_center='+$('#txt_financial_center_id').val()+'&p_curr_id_2='+$('#dp_currency_1').val()+'&p_chapter='+$('#dp_chapters').val();
              
    }
    else  if(val == 12)
    {

        url  = url +'?report_type='+type+'&report=account_name_sum_p&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_branches='+$('#dp_branch').val()+'&p_acount_parent='+$('#h_txt_parent').val();

    }
    else  if(val == 13)
    {

        url  = url +'?report_type='+type+'&report=account_name_rased_p&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_branches='+$('#dp_branch').val()+'&p_acount_parent='+$('#h_txt_parent').val();

    }
    else  if(val == 14)
    {

        url  = url +'?report_type='+type+'&report=account_name_sum_rased_p&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_branches='+$('#dp_branch').val()+'&p_acount_parent='+$('#h_txt_parent').val();
    ...
    else  if(val == 15)
    {
        ...
        url  = url +'?report_type='+type+'&report=branch_account_name_sum&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_account_parent_from='+$('#h_txt_parent').val()+'&p_account_parent_to='+$('#h_txt_parent1').val()+'&p_branches='+$('#dp_branch').val();
    ...
    else  if(val == 16)
    {
        ...
        url  = url +'?report_type='+type+'&report=account_name_rased_branch&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_account_parent_from='+$('#h_txt_parent').val()+'&p_account_parent_to='+$('#h_txt_parent1').val()+'&p_branches='+$('#dp_branch').val();
    ...
    else  if(val == 17)
    {
        ...
        url  = url +'?report_type='+type+'&report=account_name_sum_rased_branch&p_from_date='+$('#txt_date1').val()+'&p_to_date='+$('#txt_date2').val()+'&p_account_parent_from='+$('#h_txt_parent').val()+'&p_account_parent_to='+$('#h_txt_parent1').val()+'&p_branches='+$('#dp_branch').val();
    ...
    else  if(val == 18)
    {
        ...
        if (user_branch==1)
        {
            ...
            url ='{$report_jasper_url}report_type='+type+'&report=esalat_rep_'+type+'&p_d_account='+$('#h_txt_d_account').val()+'&p_voucher_id='+$('#txt_voucher_id').val()+'&p_branch='+$('#dp_branch').val()+'&p_date_from='+$('#txt_date1').val()+'&p_date_to='+$('#txt_date2').val()+'&p_income_type='+$('#dp_type').val()+'&p_debit_account_id='+$('#h_txt_account1').val()+'&p_curr_id=1';
  
        }
        else
        {
            url ='{$report_jasper_url}report_type='+type+'&report=esalat_branches_'+type+'&p_d_account='+$('#h_txt_d_account').val()+'&p_voucher_id='+$('#txt_voucher_id').val()+'&p_branch='+$('#dp_branch').val()+'&p_date_from='+$('#txt_date1').val()+'&p_date_to='+$('#txt_date2').val()+'&p_income_type='+$('#dp_type').val()+'&p_debit_account_id='+$('#h_txt_account1').val()+'&p_curr_id=1';
    ...
    else  if(val == 19)
    {
        ...
        else
        {
            if (user_branch==1)
            {
                ...
                url ='{$report_jasper_url}report_type='+type+'&report=esalat_rep_'+type+'&p_d_account='+$('#h_txt_d_account').val()+'&p_voucher_id='+$('#txt_voucher_id').val()+'&p_branch='+$('#dp_branch').val()+'&p_date_from='+$('#txt_date1').val()+'&p_date_to='+$('#txt_date2').val()+'&p_income_type='+$('#dp_type').val()+'&p_debit_account_id='+$('#h_txt_account1').val()+'&p_currtype='+$('#dp_currency').val()+'&p_curr_id=2';
  
            }
            else
            {
                    
                url ='{$report_jasper_url}report_type='+type+'&report=esalat_branches_'+type+'&p_d_account='+$('#h_txt_d_account').val()+'&p_voucher_id='+$('#txt_voucher_id').val()+'&p_branch='+$('#dp_branch').val()+'&p_date_from='+$('#txt_date1').val()+'&p_date_to='+$('#txt_date2').val()+'&p_income_type='+$('#dp_type').val()+'&p_debit_account_id='+$('#h_txt_account1').val()+'&p_currtype='+$('#dp_currency').val()+'&p_curr_id=2';
    ...
    else  if(val == 20)
    {
        ...
        url ='{$report_jasper_url}report_type='+type+'&report=sarf_rep&p_financial_payment_id='+$('#txt_payment_id').val()+'&p_branch='+$('#dp_branch').val()+'&p_date_from='+$('#txt_date1').val()+'&p_date_to='+$('#txt_date2').val()+'&p_payment_type='+$('#dp_type').val()+'&p_currtype=&p_curr_id=1';
    ...
    else  if(val == 21)
    {
        ...
        else
        {
            ...
            url ='{$report_jasper_url}report_type='+type+'&report=sarf_rep&p_financial_payment_id='+$('#txt_payment_id').val()+'&p_branch='+$('#dp_branch').val()+'&p_date_from='+$('#txt_date1').val()+'&p_date_to='+$('#txt_date2').val()+'&p_payment_type='+$('#dp_type').val()+'&p_currtype='+$('#dp_currency').val()+'&p_curr_id=2';
    ...
    else  if(val == 22)
    {
        if($('#dp_type_list').val()!='')
        {
            ...
            url ='{$report_jasper_url}report_type='+type+'&report=chick_in_out&p_v_date='+$('#txt_date1').val()+
                '&p_v_to_date='+$('#txt_date2').val()+'&p_v_check='+$('#dp_check').val()+'&p_v_type='+$('#dp_type_list').val();
        ...
        else if ($('#dp_types_lists').val()!='')
        {
            ...
            url ='{$report_jasper_url}report_type='+type+'&report=chick_in_out&p_v_date='+$('#txt_date1').val()+
                '&p_v_to_date='+$('#txt_date2').val()+'&p_v_check='+$('#dp_check').val()+'&p_v_type='+$('#dp_types_lists').val();
        ...
        else
        {
            ...
            url ='{$report_jasper_url}report_type='+type+'&report=chick_in_out&p_v_date='+$('#txt_date1').val()+
                '&p_v_to_date='+$('#txt_date2').val()+'&p_v_check='+$('#dp_check').val()+'&p_v_type=';
        }
    ...
    // End check if var have value or null //
        ...
        switch(data_report_source){
            ...
            case '1':
                ...
                switch(report_id){
                    case '1':
                        ...
                        url ='{$report_jasper_url}report_type=pdf&report=financial_book_chains&p_account_id='+account_1+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_to_account_id='+account_2+'&p_branches='+branch+'&p_curr_id='+curr_id+'&p_currtype=1&p_username={$this->user->id}&p_source='+$('#dp_fin_source').val();
                        break;

                    case '101':

                        url ='{$report_jasper_url}report_type=xls&report=financial_book_chains_xls&p_account_id='+account_1+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_to_account_id='+account_2+'&p_branches='+branch+'&p_curr_id='+curr_id+'&p_currtype=1&p_username={$this->user->id}&p_source='+$('#dp_fin_source').val();
                        break;

                    case '2':

                        url ='{$report_jasper_url}report_type=pdf&report=financial_book_chains_all&p_account_id='+account_1+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_to_account_id='+account_2+'&p_branches='+branch+'&p_curr_id='+curr_id+'&p_currtype=1&p_username={$this->user->id}&p_source='+$('#dp_fin_source').val();
                        break;
                        
                     case '3':
                     
                        url ='{$report_jasper_url}report_type=pdf&report=financial_book_chains_nogroup&p_account_id='+account_1+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_to_account_id='+account_2+'&p_branches='+branch+'&p_curr_id='+curr_id+'&p_currtype=1&p_username={$this->user->id}&p_source='+$('#dp_fin_source').val();
                        break;
            ...
            case '2':
                ...
                switch(report_id){
                    case '1':
                        url ='{$report_jasper_url}report_type=pdf&report=account_name_sum&p_account_id='+account_1+'&p_to_account_id='+account_2+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_branches='+branch+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency_2').val()+'&p_fin_center='+$('#txt_financial_center_id').val()+'&p_curr_id_2='+$('#dp_currency_1').val()+'&p_chapter='+$('#dp_chapters').val();
                        break;
                    case '2':
                        url ='{$report_jasper_url}report_type=pdf&report=account_name_rased&p_account_id='+account_1+'&p_to_account_id='+account_2+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_branches='+branch+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency_2').val()+'&p_fin_center='+$('#txt_financial_center_id').val()+'&p_curr_id_2='+$('#dp_currency_1').val()+'&p_chapter='+$('#dp_chapters').val();
                        break;
                    case '3':
                        url ='{$report_jasper_url}report_type=pdf&report=account_name_sum_rased&p_account_id='+account_1+'&p_to_account_id='+account_2+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_branches='+branch+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency_2').val()+'&p_fin_center='+$('#txt_financial_center_id').val()+'&p_curr_id_2='+$('#dp_currency_1').val()+'&p_chapter='+$('#dp_chapters').val();
                        break;
                    case '4':
                        url ='{$report_jasper_url}report_type=pdf&report=account_name_rased_sump&p_account_id='+account_1+'&p_to_account_id='+account_2+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_branches='+branch+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency_2').val();
                        break;
                    case '5':
                        url ='{$report_jasper_url}report_type=pdf&report=financial_chains_tb_review&p_account_id='+account_1+'&p_to_account_id='+account_2+'&p_from_date='+f_date+'&p_to_date='+t_date+'';
                        break;
                    case '6':
                        url ='{$report_jasper_url}report_type=pdf&report=account_name_sum_rased_withacc&p_account_id='+account_1+'&p_to_account_id='+account_2+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_branches='+branch+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency_2').val()+'&p_fin_center='+$('#txt_financial_center_id').val()+'&p_curr_id_2='+$('#dp_currency_1').val();
                        break;
                    case '7':
                        url ='{$report_jasper_url}report_type=pdf&report=proj_account_sum_rased_withacc&p_account_id='+account_1+'&p_to_account_id='+account_2+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_branches='+branch+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency_2').val()+'&p_fin_center='+$('#txt_financial_center_id').val()+'&p_curr_id_2='+$('#dp_currency_1').val();
                        break;  
                    case '8':
                        url ='{$report_jasper_url}report_type=xls&report=account_name_rased_xls&p_account_id='+account_1+'&p_to_account_id='+account_2+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_branches='+branch+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency_2').val()+'&p_fin_center='+$('#txt_financial_center_id').val()+'&p_curr_id_2='+$('#dp_currency_1').val()+'&p_chapter='+$('#dp_chapters').val();
                        break;
                    case '9':
                        url ='{$report_jasper_url}report_type=xls&report=account_name_sum_rased_xls&p_account_id='+account_1+'&p_to_account_id='+account_2+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_branches='+branch+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency_2').val()+'&p_fin_center='+$('#txt_financial_center_id').val()+'&p_curr_id_2='+$('#dp_currency_1').val()+'&p_chapter='+$('#dp_chapters').val();
                        break;
                    case '10':
                        url ='{$report_jasper_url}report_type=xls&report=financial_chains_tb_review_xls&p_account_id='+account_1+'&p_to_account_id='+account_2+'&p_from_date='+f_date+'&p_to_date='+t_date+'';
                        break;
                ...
                var report_id = $('#dp_voucher_report').val();
                    ...
                    switch(report_id){
                        case '1':
                            ...
                            url ='{$report_jasper_url}report_type=pdf&report=esalat_rep_pdf&p_d_account='+$('#h_txt_d_account').val()+'&p_voucher_id='+doc_id+'&p_branch='+branch+'&p_date_from='+f_date+'&p_date_to='+t_date+'&p_income_type='+payment_type+'&p_debit_account_id='+account_1+'&p_curr_id='+curr_id+'';
                            break;

                        case '2':
                        
                            url ='{$report_jasper_url}report_type=pdf&report=esalat_branches_pdf&p_d_account='+$('#h_txt_d_account').val()+'&p_voucher_id='+doc_id+'&p_branch='+branch+'&p_date_from='+f_date+'&p_date_to='+t_date+'&p_income_type='+payment_type+'&p_debit_account_id='+account_1+'&p_curr_id='+curr_id+'';
                            break;
            ...
            case '4':
                var report_id = $('#dp_payment_report').val();
                    ...
                    switch(report_id){
                        case '1':
                            url ='{$report_jasper_url}report_type=pdf&report=sarf_rep&p_financial_payment_id='+doc_id+'&p_branch='+branch+'&p_date_from='+f_date+'&p_date_to='+t_date+'&p_payment_type='+payment_type+'&p_currtype=1&p_curr_id='+curr_id+'';
                            break;
                      
                        case '2':
                            url ='{$report_jasper_url}report_type=pdf&report=sarf_rep&p_financial_payment_id='+doc_id+'&p_branch='+branch+'&p_date_from='+f_date+'&p_date_to='+t_date+'&p_payment_type='+payment_type+'&p_currtype=2&p_curr_id='+curr_id+'';
                            break;
            ...
            case '5':
                ...
                switch(report_id){
                    case '1':
                        ...
                        url ='{$report_jasper_url}report_type=pdf&report=financial_book_chains_customer&p_account_id='+customer_id+'&p_to_account_id='+customer_id+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_branches='+branch+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency_2').val()+'&p_username={$this->user->id}&p_curr_id_2='+$('#dp_currency_1').val();
                        break;  
                        
  			        case '101':

                        url ='{$report_jasper_url}report_type=xls&report=financial_book_chains_customer_xls&p_account_id='+customer_id+'&p_to_account_id='+customer_id+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_branches='+branch+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency_2').val()+'&p_username={$this->user->id}&p_curr_id_2='+$('#dp_currency_1').val();
                        break;  

                    case '2':

                        url ='{$report_jasper_url}report_type=pdf&report=financial_book_chains_all_customer&p_account_id='+customer_id+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_to_account_id='+customer_id+'&p_branches='+branch+'&p_curr_id='+curr_id+'&p_currtype=1&p_username={$this->user->id}';
                        break;
                ...
                switch(report_id){
                    case '1':
                        ...
                        url ='{$report_jasper_url}report_type=pdf&report=financial_book_chains_car&p_account_id='+account_1+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_to_account_id='+account_1+'&p_branches='+branch+'&p_curr_id='+curr_id+'&p_currtype=1&p_username={$this->user->id}';
                        break;

                    case '2':

                        url ='{$report_jasper_url}report_type=pdf&report=financial_book_chains_all_car&p_account_id='+account_1+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_to_account_id='+account_1+'&p_branches='+branch+'&p_curr_id='+curr_id+'&p_currtype=1&p_username={$this->user->id}';
                        break;
                }
        ...
        case '8':
                ...
                switch(report_id){
                    case '1':
                        ...
                        url ='{$report_jasper_url}report_type=pdf&report=customers_balances&p_account_id='+customer_id+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_to_account_id='+customer_id1+'&p_customer_type='+customer_type+'&p_account='+account_1+'';
                        break;
            ...
            var report_id = $('#dp_t_report').val();
                ...
                switch(report_id){
                    case '1':
                        ...
                        url ='{$report_jasper_url}report_type=pdf&report=financial_book_chains_projects&p_account_id='+project_account+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_to_account_id='+project_account+'&p_branches='+branch+'&p_curr_id='+curr_id+'&p_currtype=1&p_username={$this->user->id}&p_source='+$('#dp_fin_source').val();
                        break;

                    case '2':

                        url ='{$report_jasper_url}report_type=pdf&report=financial_book_chains_allprojects&p_account_id='+project_account+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_to_account_id='+project_account+'&p_branches='+branch+'&p_curr_id='+curr_id+'&p_currtype=1&p_username={$this->user->id}&p_source='+$('#dp_fin_source').val();
                        break;
                }
break;
