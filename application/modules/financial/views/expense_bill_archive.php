...
$get_page_url = base_url('financial/expense_bill/get_archive_page');
?>
...
<div class="row">
    ...
    <div class="form-body">
        ...
        <div id="container">
            <?=modules::run('financial/expense_bill/get_archive_page',$page);?>
        </div>
...
<script>
    ...
    ajax_pager({id : $('#txt_entry_ser').val(),name:$('#txt_customer_name').val(),from_date:$('#txt_from_date').val(),to_date:$('#txt_to_date').val()});

    }

    function LoadingData(){

    ajax_pager_data('#expenseTbl > tbody',{id : $('#txt_entry_ser').val(),name:$('#txt_customer_name').val(),from_date:$('#txt_from_date').val(),to_date:$('#txt_to_date').val()});
   ...
   function do_search(){
        ...
        get_data('{$get_page_url}',{page: 1,id : $('#txt_entry_ser').val(),name:$('#txt_customer_name').val(),from_date:$('#txt_from_date').val(),to_date:$('#txt_to_date').val()},function(data){
            $('#container').html(data);
