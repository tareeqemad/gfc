...
class Accounts_model extends MY_Model{
    ...
    function getList2($user = null,$level  = 0,$curr_id = null){
        ...
        $result = $this->New_rmodel->general_get('financial_pkg','ACOUNTS_TB_GET_LIST_TYPE2',$params);
        return $result;
    }
    ...
    function getList2B($branch = null,$level  = 0,$curr_id = null){
        ...
        $result = $this->New_rmodel->general_get('financial_pkg','ACOUNTS_TB_GET_LIST_TYPE2B',$params);
        return $result;
    }
    /**
     * @param int $parent
     ...
     * get list of accounts deepened on parent id
     */
    function getList_S($parent = 0,$user = null,$level  = 0,$curr_id = null,$type = null,$store = null){
        ...
        $params =array(
            ...
            array('name'=>':Level_IN','value'=>$level,'type'=>'','length'=>-1),
            array('name'=>':STORE_ID_IN','value'=>$store,'type'=>'','length'=>-1),
            array('name'=>':REF_CUR_OUT','value'=>'cursor','type'=>OCI_B_CURSOR),
            array('name'=>':MSG_OUT','value'=>'MSG_OUT','type'=>SQLT_CHR,'length'=>-1),
        );

        $result = $this->New_rmodel->general_get('financial_pkg','ACOUNTS_TB_GET_LIST_S',$params);
        return $result;
    }
    /**
     * @param int $parent
    ...
    function getList_Table($parent = 0,$user = null,$level  = 0,$curr_id = null,$type = null){
        ...
        $result = $this->New_rmodel->general_get('MV_PKG','ACOUNTS_TB_GET_LIST_Table',$params);
        return $result;
    }
    ...
    function getList_parent($parent = 0,$user = null,$level  = 0,$curr_id = null){
        ...
        $result = $this->New_rmodel->general_get('financial_pkg','ACOUNTS_TB_GET_PARENT',$params);
        return $result;

    }

    function acounts_tb_get_not_cur_master($account_type = null){

        $params =array(
            array('name'=>':ACOUNT_TYPE_IN','value'=>"{$account_type}",'type'=>'','length'=>-1),

            array('name'=>':REF_CUR_OUT','value'=>'cursor','type'=>OCI_B_CURSOR),
            array('name'=>':MSG_OUT','value'=>'MSG_OUT','type'=>SQLT_CHR,'length'=>-1),
        );
        $result = $this->New_rmodel->general_get('financial_pkg','ACOUNTS_TB_GET_NOT_CUR_MASTER',$params);
        return $result;
