    ...
    $(document).ready(function() {
        ...
        $('#section, #txt_user_position').change(function(){
          ...
          $('#txt_type').change(function(){
            $('#section').text('');
            get_data('$section_url', {type:$('#txt_type').val(),user_position:$('#txt_user_position').val()}, function(ret){ $('#section').html(ret);
                   $('#txt_section').select2();
                 }, 'html');
        ...
        $('#txt_user_position').change(function(){
            ...
            if($('#txt_user_position').val() !=0 ){
                get_data('$section_url', {type:$('#txt_type').val(),user_position:$('#txt_user_position').val()}, function(ret){
                 $('#section').html(ret);
               //  $('#txt_section').select2();
                }, 'html');
            }
