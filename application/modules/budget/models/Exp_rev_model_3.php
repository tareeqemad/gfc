 ...
 * Time: 10:15 ص
 */
class Exp_rev_model_3 extends MY_Model
{
    ...
    function adopt($no,$adopt,$year,$branch,$action)
    {
        $params = array(
        ...
        $result = $this->conn->excuteProcedures($this->PKG_NAME, $this->TABLE_NAME . '_ADOPT3', $params);
        return $result['MSG_OUT'];
    }

    function cancel_adopt($no, $year, $branch, $adopt)
    {
        $params = array(
            array('name' => ':NO_IN', 'value' => $no, 'type' => '', 'length' => -1),
            array('name' => ':ADOPT_IN', 'value' => $adopt, 'type' => '', 'length' => -1),
    ...
    function get_total($section_no,$yyear,$branch,$exp_rev_type,$adopt){
        ...
        $result = $this->New_rmodel->general_get($this->PKG_NAME, $this->TABLE_NAME.'_GET_TOTAL1',$params);
        return $result;
    }
    ...
    function trans_up( $yyear, $branch,$section_no)
    {
        $params = array(
              array('name' => ':YYEAR_IN', 'value' => $yyear, 'type' => '', 'length' => -1),
              array('name' => ':BRANCH_IN', 'value' => $branch, 'type' => '', 'length' => -1),
        ...
        $result = $this->conn->excuteProcedures($this->PKG_NAME, 'BUDGET_EXP_REV_TB_TRANS_UP', $params);
        return $result['MSG_OUT'];
    }
    function cancel_trans_up( $yyear, $branch,$section_no)
    {
        $params = array(
            array('name' => ':YYEAR_IN', 'value' => $yyear, 'type' => '', 'length' => -1),
            array('name' => ':BRANCH_IN', 'value' => $branch, 'type' => '', 'length' => -1),
        ...
        $result = $this->conn->excuteProcedures($this->PKG_NAME, 'BUDGET_EXP_REV_TB_TRANS_CANCEL', $params);
        return $result['MSG_OUT'];
    }
    function trans_projects( $yyear, $branch,$section_no)
    {
        $params = array(
            array('name' => ':YYEAR_IN', 'value' => $yyear, 'type' => '', 'length' => -1),
            array('name' => ':BRANCH_IN', 'value' => $branch, 'type' => '', 'length' => -1),
        ...
        $result = $this->conn->excuteProcedures($this->PKG_NAME, 'BUDGET_PROJECTS_FILE_TB_TRAN ', $params);
        return $result['MSG_OUT'];
    }
