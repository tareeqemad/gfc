        ...
        <?php endif;{?>
            ...
            <?php foreach ($rows as $row) : ?>
                ...
                <tr  >
                    ...
                    <td><input type="text"  value="<?= $row['BOND_BODY']?>" name="bond_body[]" id="txt_BOND_BODY" class="form-control">
                    </td>

                    <td><input type="text"  value="<?= $row['AMOUNT']?>"  name="amount[]"   id="txt_AMOUNT" class="form-control">
                    </td>

                   <td><input type="text"  value="<?= $row['ELECTRONIC_ARCHIVE']?>"  name="electronic_archive[]"
                               id="txt_ELECTRONIC_ARCHIVE" class="form-control"></td>

                    <td>  <a href="<?=base_url("Destruction/Bonds/get_bonds_info/{$row['BOND_SER']}" )?>"><i class='glyphicon glyphicon-share'></i></a>
                    </td>
