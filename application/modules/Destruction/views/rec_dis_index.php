...
$TB_NAME = 'REC_DIS';
$get_url =base_url('Destruction/REC_DIS/get_id');

$creates_url=base_url('Destruction/REC_DIS/create');

$adopt_url=base_url('Destruction/REC_DIS/adopt');
$unadopt_url=base_url('Destruction/REC_DIS/unadopt');
...
<div class="row">
    ...
    <div class="form-body">
        ...
        <fieldset>
                ...
                <div class="form-group col-sm-2">
                    ...
                    <div>
                        <input type="text" data-type="date" data-date-format="DD/MM/YYYY"
                               name="model_date" id="txt_RE_DIS_DATE"
            ...
            <!------------------- الملاحظات------------------->
                ...
                <div class="form-group col-sm-3">
                    ...
                    <div>
                        <input type="text"  name="notes"  value="<?= $HaveRs ? $rs['NOTES'] : "" ?>"
                               id="txt_NOTES" class="form-control ltr">
                    </div>
                </div>
                <!----------------------------------------------------->
        ...
        <fieldset>
            <legend>نموذج اتلاف سندات القبض وسندات الصرف</legend>
            <div id="container">
                <?php echo modules::run('Destruction/REC_DIS/get_page_REC_DIS' ); ?>

                <?php //echo modules::run('Destruction/REC_DIS/public_list_REC_DIS_det', $HaveRs ? $rs['SER'] : ""); ?>
            </div>
        </fieldset>
