...
$exceptional_credit_url =base_url("$MODULE_NAME/Exceptional_credit/index");
...
<div class="page-header">
    <div>
        <h1 class="page-title">فئات بدل الاتصال</h1>
    </div>
            ...
            <div class="card-header align-items-center d-flex py-3">
                ...
                <div class="flex-shrink-0">
                    ...
                    <?php if (HaveAccess($delete_url)): ?>
                        <a class="btn btn-danger" onclick='javascript:<?= $TB_NAME ?>_delete();' href='javascript:;'><i class='glyphicon glyphicon-remove'></i>حذف</a>
                    <?php endif; ?>

                    <?php if (HaveAccess($get_url) and HaveAccess($edit_url)): ?>
                        <a class="btn btn-success" onclick='javascript:<?= $TB_NAME ?>_get(get_id());' href='javascript:;'><i class='glyphicon glyphicon-edit'></i>تحرير</a>
                    <?php endif; ?>

                    <?php if (HaveAccess($create_url)): ?>
                        <a class="btn btn-info" onclick='javascript:<?= $TB_NAME ?>_create();' href='javascript:;'><i class='glyphicon glyphicon-plus'></i>جديد </a>
                    <?php endif; ?>
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">بيانات الفئة</h5>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="form-group col-md-3">
                                <label class="control-label">رقم الفئة</label>
                            ...
                            <div class="form-group col-md-3">
                                <label class="control-label">مبلغ الفئة</label>
                                <input type="text" name="tb_amount" id="txt_tb_amount" class="form-control">
                            </div>
    ...
    function {$TB_NAME}_get(id){
        get_data('{$get_url}',{id:id},function(data){
            $.each(data, function(i,item){
                ...
                $('#txt_tb_amount').val( item.TB_AMOUNT);
