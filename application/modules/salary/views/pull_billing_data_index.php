...
<div class="breadcrumb-header justify-content-between">
    ...
    <div class="justify-content-center mt-2">
        <ol class="breadcrumb">
            <li class="breadcrumb-item tx-15"><a href="javascript:void(0);">بدل الاتصال</a></li>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="flex-shrink-0">
                    ...
                    <button type="button" onclick="$('#pull_billing_data_tb').tableExport({type:'excel',escape:'false'});"
...
<script type="text/javascript">
    ...
    function trans_data(){
        ...
        if (month == '') {
            ...
            get_data('{$trans_url}',{month: month}, function (data) {
                if(data>=1){
    ...
    function values_search(add_page){
        var values= {page:1,branch_no:$('#dp_branch_no').val(),emp_no:$('#dp_emp_no').val(),the_month:$('#txt_the_month').val()};
        if(add_page==0)
            delete values.page;
        return values;
    }
    ...
    function LoadingData(){
        ...
        ajax_pager_data('#pull_billing_data_tb > tbody',values);
    }
    ...
    function show_row_details( month ){
        get_to_link('{$get_url}/'+month);
    }
