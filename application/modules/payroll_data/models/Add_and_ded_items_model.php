...
class Add_and_ded_items_model extends MY_Model {
    var $PKG_NAME = "TRANSACTION_PKG";
    var $TABLE_NAME = 'ADD_AND_DED_ITEMS';
    ...
    function get_list($sql,$offset,$row){
        ...
        $result = $this->New_rmodel->general_get($this->PKG_NAME,'ADD_AND_DED_ITEMS_LIST',$params);
        return $result;
    }
