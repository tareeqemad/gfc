...
class Bonuses_model extends MY_Model{

    var $PKG_NAME= "TRANSACTION_PKG";
    var $TABLE_NAME= 'WORKN_TB';
    ...
    function get_max_no(){
        ...
        $result = $this->New_rmodel->general_get($this->PKG_NAME,'MAX_WORKN_NO_GET',$params);
        return $result;
    }
    ...
    function get_archives($sql,$offset,$row){
        ...
        $result = $this->New_rmodel->general_get($this->PKG_NAME,'WORKN_ARCH_TB_LIST',$params);
        return $result;
    }
