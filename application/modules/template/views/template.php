...
if($this->session->userdata('db_instance') == 'GFCARCH'){
    ...
    $sys_year='2017';
}elseif($this->session->userdata('db_instance') == 'HR'){
    $sys_year='2018';
}else
*/
...
<head>
   ...
   <?php if (isset($css_file)) : ?>
        <link rel="stylesheet" href="<?= base_url($css_file); ?>" type="text/css"></link>
    <?php endif; ?>
...
<div class="header">
    ...
    <div class="main-menu row">
        <ul class="nav navbar-nav">
            ...
            <?//= modules::run('settings/sysmenus/public_get_system', 1) //old 202208 ?>
            <?=get_systems() //new 202208 ?>
            <li style="display: none"><a style="background-color: #703801" href="../../../../../<?=$this->session->userdata('sys_paths')['TASK']?>" title="">سطح المكتب</a></li>
