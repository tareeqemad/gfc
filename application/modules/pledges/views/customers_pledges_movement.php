...
<fieldset>
    ...
    <div class="form-group col-sm-3">
        ...
        <div>
            ...
            <input type=hidden name="customer_id"  value="<?php echo $rs['CUSTOMER_ID'];?>"   data-type="text"   id="h_customer_id" class="form-control ">
			  <input type="hidden" name="room_id"  value="<?php if (count($rs)>0)echo $rs['ROOM_ID'] ;?>"      id="txt_room_id" class="form-control " >
			   <input type="hidden" name="room_name"  value="<?php if (count($rs)>0)echo $rs['ROOM_ID_NAME'] ;?>"     id="txt_room_name" class="form-control "   >
    ...
    <div class="form-group col-sm-2">
        ...
        <div>
            ...
            <input type="text" name="manage_st_id_name" value="<?php echo $rs['MANAGE_ST_ID_NAME'] ;?>"  readonly  data-type="text"   id="txt_manage_st_id_name" class="form-control " readonly>
            <input type="hidden" name="manage_st_id"  value="<?php echo $rs['MANAGE_ST_ID'];?>"   data-type="text"   id="h_manage_st_id" class="form-control ">
    ...
    <div class="form-group col-sm-2">
        ...
        <div>
            ...
            <input type="text" name="cycle_st_id_name" value="<?php echo $rs['CYCLE_ST_ID_NAME'] ;?>"  readonly  data-type="text"   id="txt_cycle_st_id_name" class="form-control " readonly>
            <input type="hidden" name="cycle_st_id"  value="<?php echo $rs['CYCLE_ST_ID'];?>"   data-type="text"   id="h_cycle_st_id" class="form-control ">
    ...
    <div class="form-group col-sm-2">
        ...
        <div>
            ...
            <input type="text" name="department_st_id_name" value="<?php echo $rs['DEPARTMENT_ST_ID_NAME'] ;?>"  readonly  data-type="text"   id="txt_department_st_id_name" class="form-control " readonly>
            <input type="hidden" name="department_st_id"  value="<?php echo $rs['DEPARTMENT_ST_ID'];?>"   data-type="text"   id="h_department_st_id" class="form-control ">
...
<hr/>
<fieldset>
    <legend>  بيانات الموظف المنقول له</legend>

        <div class="form-group col-sm-2">
            <label class="control-label">نوع المستفيد المنقول اليه</label>
            <div>
                <select name="customer_movment_type" id="dp_customer_movment_type" class="form-control" >
                    <?php foreach($customer_type_cons as $row) :?>
                        <option <?=!$isCreate?($rs['CUSTOMER_MOVMENT_TYPE']==$row['CON_NO']?'selected':''):''?> value="<?=$row['CON_NO']?>" ><?=$row['CON_NAME']?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
    ...
    <div class="form-group col-sm-2" id="customer_movment_div_1">

        <label class="control-label">الموظف المنقول له</label>
        <div>
            <select  name="customer_movment_id" id="dp_customer_movment_id"  data-curr="false"  class="form-control" data-val="true" data-val-required="حقل مطلوب" >
                <option value="">___________________________________</option>
                <?php foreach($customer_ids as $row) :?>
                    <option  value="<?= $row['ID'] ?>" <?PHP  if (count($rs)>0) {if ($row['ID']==$rs['CUSTOMER_MOVMENT_ID']){ echo " selected"; }} ?> ><?=$row['NO'].'-'.$row['NAME']?></option>
                <?php endforeach; ?>
            </select>
            <span class="field-validation-valid" data-valmsg-for="customer_movment_id" data-valmsg-replace="true"></span>
        </div>
		 <input type="hidden" name="room_movement_id"  value="<?php if (count($rs)>0)echo $rs['ROOM_MOVEMENT_ID'] ;?>"  readonly  data-type="text"   id="txt_room_movement_id" class="form-control   >
          <input type="hidden" name="room_movement_id_name"  value="<?php if (count($rs)>0)echo $rs['ROOM_MOVEMENT_ID_NAME'] ;?>"  readonly  data-type="text"   id="txt_room_movement_id_name" class="form-control "   >
              
    </div>

   <div class="form-group col-sm-2" id="customer_movment_div_2">
        <label class="control-label">الغرف </label>
        <div>
            <select name="customer_movment_id2" id="dp_customer_movment_id2" class="form-control" >
                <option value="">_________</option>
                <?php foreach($rooms_cons as $row) :?>
                    <option <?=!$isCreate?($rs['CUSTOMER_MOVMENT_ID']==$row['ROOM_ID']?'selected':''):''?> value="<?=$row['ROOM_ID']?>" ><?=$row['ROOM_ID'].': '.$row['ROOM_PARENT_NAME'].' - '.$row['ROOM_NAME']?></option>
                <?php endforeach; ?>
            </select>
        </div>
    </div>
...
<!--
    <div class="form-group col-sm-1">
        ...
        <div>
            <input type="text" name="room_movement_id" data-val="true" value="<?php if (count($rs)>0)echo $rs['ROOM_MOVEMENT_ID'] ;?>"  readonly  data-type="text"   id="txt_room_movement_id" class="form-control "data-val-required="حقل مطلوب"  >
            <span class="field-validation-valid" data-valmsg-for="room_movement_id" data-valmsg-replace="true"></span>
    ...
    <div class="form-group col-sm-3">
        ...
        <div>
            <input type="text" name="room_movement_id_name" data-val="true" value="<?php if (count($rs)>0)echo $rs['ROOM_MOVEMENT_ID_NAME'] ;?>"  readonly  data-type="text"   id="txt_room_movement_id_name" class="form-control " data-val-required="حقل مطلوب"  >
            <span class="field-validation-valid" data-valmsg-for="room_movement_id_name" data-valmsg-replace="true"></span>
...
-->
    <div class="form-group col-sm-2">
        <label class="control-label">الادارة</label>
        <div>
            <select  name="movment_manage_st_id" id="dp_movment_manage_st_id"  data-curr="false"  class="form-control" data-val="true" data-val-required="حقل مطلوب" >
            <option value="">___________________________________</option>
            <?php foreach($manage_st_ids as $row) :?>
                <option  value="<?= $row['ST_ID'] ?>" <?PHP  if (count($rs)>0) {if ($row['ST_ID']==$rs['MOVMENT_MANAGE_ST_ID']){ echo " selected"; }} ?> ><?php echo $row['ST_NAME']  ?></option>
            <?php endforeach; ?>
            </select>
            <span class="field-validation-valid" data-valmsg-for="movment_manage_st_id" data-valmsg-replace="true"></span>
        </div>
    </div>
    <div class="form-group col-sm-2">
        <label class="control-label">الدائرة</label>
        ...
        <div>
            ...
            <option value="">___________________________________</option>
            <?php
                foreach($gcc_structure_show_cycle as $row) :?>
            ...
            <span class="field-validation-valid" data-valmsg-for="movment_cycle_st_id" data-valmsg-replace="true"></span>
        </div>
    </div>
    <div class="form-group col-sm-2">
        <label class="control-label">القسم</label>
        <div>
            <select  name="movment_depart_st_id" id="dp_movment_depart_st_id"  data-curr="false"  class="form-control" data-val="true" <!--data-val-required="حقل مطلوب"--> >
            <option value="<?php echo $rs['MOVMENT_DEPART_ST_ID'];?>"><?php echo $rs['MOVMENT_DEPART_ST_ID_NAME'];  ?></option>

            </select>
            <span class="field-validation-valid" data-valmsg-for="movment_depart_st_id" data-valmsg-replace="true"></span>
        </div>
    </div>
...
<div class="modal-footer">
    ...
    <?php if ( !$isCreate  and $rs['ADOPT']!=0 and $rs['STATUS']==2  and  $rs['FOLLOW_FILE_ID']<>'') : ?>
    ...
    <?php //echo ( $rs['ADOPT']==1 and isset($can_edit)?$can_edit:false) ;
    if (  HaveAccess($exe_url) && ( ( $rs['ADOPT']==2 and  $rs['FOLLOW_FILE_ID']=='') and $rs['STATUS']==2 )) : ?>
        <button type="button" id="btn_adopt" onclick='javascript:return_adopt(this,1);' class="btn btn-danger">تنفيذ نقل عهدة</button>
    <?php endif; ?>
...
$('#dp_customer_movment_id2').select2();

var type = $('#dp_movment_manage_st_id').val();
			$.ajax({
				type:'post',
				url:'{$cycle_url}',
   ...
   $("#dp_movment_cycle_st_id").prop("disabled", true);
  // $("#dp_movment_depart_st_id").prop("disabled", true);
    },
				success: function(returndata){
				$("#dp_movment_cycle_st_id").prop("disabled", false);
				$('#dp_movment_cycle_st_id').html(returndata);
...
var type1 = $('#dp_movment_cycle_st_id').val();
			$.ajax({
				type:'post',
				url:'{$department_url}',
				data:{id:type1,file_id:$('#txt_file_id').val()},
				cache:false,
				beforeSend:function(){
    // this is where we append a loading image
    //$("#dp_movment_depart_st_id").val('');
   $("#dp_movment_depart_st_id").prop("disabled", true);
    },

				success: function(returndata){
				$("#dp_movment_depart_st_id").prop("disabled", false);
				$('#dp_movment_depart_st_id').html(returndata);
				}
			});
    ...
    // Mkilani
    $('#customer_movment_div_2').hide(0);
    customer_movment_type_change();
    
    $('#dp_customer_movment_type').change(function(){
        customer_movment_type_change();
    });
    
    function customer_movment_type_change(){
        var type_= $('#dp_customer_movment_type').val();
        if(type_==4){
            $('#customer_movment_div_2').show(500);
            $('#customer_movment_div_1').hide(500);
        }else {
            $('#customer_movment_div_1').show(500);
            $('#customer_movment_div_2').hide(500);
        }
    }
    // Mkilani
...
function clear_form(){
     ...
     $('#dp_customer_movment_id').select2().on('change',function(){
  get_data('{$get_customer_url}',{id:$('#dp_customer_movment_id').val()},function(data){
    

       if(Object.keys(data).length>=1)
       { 
           var emp_info=data[0];
            $('#txt_room_movement_id').val(emp_info.ROOM_ID);
        $('#txt_room_movement_id_name').val(emp_info.ROOM_NAME);
   $('#dp_movment_manage_st_id').select2("val",emp_info.MANAGE); //set the value
	var type = $('#dp_movment_manage_st_id').val();
			$.ajax({
				type:'post',
				url:'{$cycle_url}',
   ...
   $("#dp_movment_depart_st_id").prop("disabled", true);
				...
				$("#dp_movment_cycle_st_id").prop("disabled", false);
				$('#dp_movment_cycle_st_id').html(returndata);
				$('#dp_movment_cycle_st_id').select2("val",emp_info.CYCLE); //set the value
				}
			});

			var cycle = emp_info.CYCLE;
			var type = $('#dp_movment_cycle_st_id').val();
			$.ajax({
				type:'post',
				url:'{$department_url}',
				data:{id:cycle,file_id:$('#txt_file_id').val()},
				cache:false,
				beforeSend:function(){
    // this is where we append a loading image
    //$("#dp_movment_depart_st_id").val('');
   $("#dp_movment_depart_st_id").prop("disabled", true);
				...
				$("#dp_movment_depart_st_id").prop("disabled", false);
				$('#dp_movment_depart_st_id').html(returndata);
				$('#dp_movment_depart_st_id').select2("val",emp_info.DEPT); //set the value
				}
			});
} else {
        $('#txt_room_movement_id').val('');
        $('#txt_room_movement_id_name').val('');
   $('#dp_movment_manage_st_id').select2("val",'');    
	$('#dp_movment_cycle_st_id').select2("val",'');
$('#dp_movment_depart_st_id').select2("val",''); 
}
       ...
       function return_adopt(obj,type){
       if (isDoubleClicked($(obj))) return;
        ...
        function apply_action(){
                ...
                if(action_type == 1){
                    ...
                    if(data =='1')
                            success_msg('رسالة','تم نقل العهدة بنجاح ..');
                            reload_Page();
                    },'html');
...
$( "#print_rep" ).on( 'click', function (){
        ...
        url ='$jasper_url'+'&report_type=pdf&report=own_customer_rep&p_file_id='+$('#txt_file_id').val();
        
          _showReport(url);
});

 $('#dp_movment_manage_st_id').select2().on('change',function(){
          	$('#dp_movment_cycle_st_id').select2("val",''); //set the value
          		$('#dp_movment_depart_st_id').select2("val",''); //set the value

        });
         $('#dp_movment_cycle_st_id').select2().on('change',function(){
         	$('#dp_movment_depart_st_id').select2("val",''); //set the value

        });
          $('#dp_movment_depart_st_id').select2().on('change',function(){

        });

        $('button[data-action="submit"]').click(function(e){
			e.preventDefault();
        if(confirm('هل تريد نقل العهدة ؟!')){
...
$('#dp_movment_manage_st_id').change(function(){
		var type = $('#dp_movment_manage_st_id').val();
			$.ajax({
				type:'post',
				url:'{$cycle_url}',
...
$('#dp_movment_cycle_st_id').change(function(){
