    ...
    <fieldset>
       ...
       //    else
        ...
        //    }?>
					...
					<?php if ($rs['STATUS']==4 AND $rs['FOLLOW_FILE_ID'] != '' ) {
?>
                <div class="form-group col-sm-2">
                    <label class="control-label">عرض سند الإرجاع</label>
                    <div>

                        <a target="_blank" href="<?php  echo $stores_return_url."/".$rs['FOLLOW_FILE_ID']."/edit"; ?>"><?=$rs['FOLLOW_FILE_ID']?></a>
                    </div>
                </div>
<?php
}
...
<div class="modal-footer">
    ...
    if (  HaveAccess($exe_url) && ( ( $rs['ADOPT']==2 and  $rs['FOLLOW_FILE_ID']=='') and $rs['STATUS']==4 )) : ?>
        <button type="button" id="btn_adopt" onclick='javascript:return_adopt(this,1);' class="btn btn-danger">تنفيذ ارجاع العهدة الى المخزن</button>
    <?php endif; ?>
