...
$print_code_url= base_url("$MODULE_NAME/class_codes/print_case_codes");
$post_url='';
$rep_url = base_url('greport/reports/public_inventory_pledges_barcode');
            ...
            <form class="form-vertical" id="<?=$TB_NAME?>_form" method="post" action="<?=$post_url?>" role="form" novalidate="novalidate">
               ...
               <!--     <div class="form-group col-sm-3">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <?php } ?>
                        <?php   if (HaveAccess($code_url) and $rs['BARCODE']==''  and $rs['STATUS']==1 and $rs['CLASS_ACOUNT_TYPE']==1){ //
                            ?>
