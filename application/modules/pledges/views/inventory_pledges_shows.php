...
$get_code_url  =base_url("$MODULE_NAME/customers_pledges/public_get_id");
...
//$cycle_url =base_url("$MODULE_NAME/customers_pledges/public_gcc_structure_cycle");
//$department_url =base_url("$MODULE_NAME/customers_pledges/public_gcc_structure_dep");
//echo "<pre>" ; print_r($rs);

$get_customer_class_details=base_url("$MODULE_NAME/$TB_NAME/public_get_inventory_class_file_ids");
            ...
            <div class="modal-body inline_form">
                    ...
                    <div class="form-group col-sm-2" id="customer_div_1">
					 ...
					 <div class="form-group col-sm-2" id="customer_div_2">
                        ...
                        <div>
						 ...
						 <input type="hidden" name="room_id"  value="<?php if (count($rs)>0)echo $rs['ROOM_ID'] ;?>"  readonly  data-type="text"   id="txt_room_id" class="form-control "  >
                     <input type="hidden" name="room_name"  value="<?php if (count($rs)>0)echo $rs['ROOM_ID_NAME'] ;?>"  readonly  data-type="text"   id="txt_room_name" class="form-control "   >
               ...
               <!-- <div class="form-group col-sm-1">
                    ...
                    <div class="form-group col-sm-9">
                        ...
                        <div >
                            <input type="text"   name="notes" id="txt_notes" class="form-control" dir="rtl" value="<?php echo (count($rs)>0)? $rs['NOTES']: '' ;?>" >
                ...
                <fieldset>
                    ...
                    <div class="form-group col-sm-1">
                        ...
                        <div>
                            <input class="form-control" type="text" name="class_id" readonly id="h_txt_class_id" value="<?php echo (count($rs)>0)? $rs['CLASS_ID']: '' ;?>" data-val="true" data-val-required="حقل مطلوب"  >
                ...
                <div class="modal-footer">
                   ...
                   -->
                    ...
                    <?php //if ( HaveAccess($public_return_url) && (!$isCreate and ( (count($rs)>0)? $rs['ADOPT']==2 : '' ) and $rs['STATUS']==1)) : ?>
                      <!--  <button type="button" onclick="javascript:return_adopt(0);" class="btn btn-danger">الغاء الاعتماد</button>
                   -->
                    <?php //endif; ?>
                    <?php if ($isCreate): ?>
                ...
                <div style="clear: both;">
                    <span id="quote"><?php echo  (count($rs)>0 && $rs['STATUS']==2 && $rs['FOLLOW_FILE_ID']!='')?  modules::run('attachments/attachment/index',$rs['FOLLOW_FILE_ID'],'inventory_pledges_tb') : ''; ?>
  </span>
                </div>
        </form>
    </div>
...
if(action_type == 0) {
                ...
                get_data('{$notes_url}',{source_id:{$fid},source:'inventory_pledges_tb',notes:$('#txt_g_notes').val()},function(data){
                    $('#txt_g_notes').val('');
                },'html');
...
$( "#print_rep" ).on( 'click', function (){
    _showReport('$jasper_url'+'&report_type=pdf&report=own_customer_rep&p_file_id='+$('#txt_file_id').val());
});
