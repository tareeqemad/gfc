...
class Rooms_structure_tree extends MY_Controller{
    ...
    function public_select_rooms($txt= null, $branch= null){
        ...
        $data["room_accounts_cons"]=  $this->constant_details_model->get_list(446);
