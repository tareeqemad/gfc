...
*/
    ...
    function excute(){
        $create_time= time();
        if($create_time < $this->session->userdata('cp_execute_create_time') + 15){
            $this->print_error("انتظر 15 ثانية ثم حاول مرة اخرى"); die();
        }
        $this->session->set_userdata('cp_execute_create_time', $create_time);
