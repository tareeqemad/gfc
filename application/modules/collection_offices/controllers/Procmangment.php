...
class Procmangment extends MY_Controller
{
    ...
    function index($page = 1)
    {
        ...
        $data['title'] = 'ادارة الاجراءات';
        $data['content'] = 'Procmangment_index';
    ...
    function get_page($page = 1)
    {
        ...
        $config['base_url'] = base_url("training/Procmangment/get_page/");
        ...
        if($this->p_proc_type == 1){

            $data["rows"] = $this->rmodel->getList('OUT_CUSTOM_PROCEDURES_LIST', " $sql ", $offset, $row);

        }else{

            $data["rows"] = $this->rmodel->getList('OUT_LEGAL_PROCEDURES_LIST', " $sql ", $offset, $row);
        ...
        $data['proc_type'] = $this->p_proc_type;
        $this->load->view('Procmangment_page', $data);
    }
