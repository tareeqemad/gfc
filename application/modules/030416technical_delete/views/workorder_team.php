            ...
            foreach ($details as $row) {
                ...
                <tr>
                    ...
                    <td data-action="delete">
                        ...
                        <?php if ( $can_edit && HaveAccess(base_url('technical/WorkOrder/delete_team'))) : ?>
                            <a href="javascript:;" onclick="javascript:delete_details(this,<?= $row['SER'] ?>,'<?= base_url('technical/WorkOrder/delete_team') ?>');"><i class="icon icon-trash delete-action"></i> </a>
                        <?php endif; ?>
