...
<div class="page-header">
    ...
    <div class="ms-auto pageheader-btn">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">أنواع الاشتراكات</li>
        </ol>
    </div>
</div>
<!-- PAGE-HEADER END -->
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form class="form-vertical" id="<?=$TB_NAME?>_form" >
                    <div class="row">
                        ...
                        <div class="form-group col-sm-2">
                            ...
                            <div>
                                <input type="text" name="subscriber_type" id="txt_subscriber_type" class="form-control"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-sm-1">
                            ...
                            <div>
                                <input type="text" name="subscribe_fees" id="txt_subscribe_fees" class="form-control" onkeypress="return (event.charCode !=8 && event.charCode ==0 || ( event.charCode == 46 || (event.charCode >= 48 && event.charCode <= 57)))"/>
                            </div>
                        </div>
                ...
                <div class="flex-shrink-0">
                    ...
                    <button type="button" onclick="$('#subscribers_types_tb').tableExport({type:'excel',escape:'false'});" class="btn btn-success"><i class="fas fa-file-excel"></i>إكسل</button>
...
<script type="text/javascript">
    ...
    function values_search(add_page){
        var values= { page:1,ser:$('#txt_ser').val(), subscriber_type:$('#txt_subscriber_type').val(), subscribe_fees:$('#txt_subscribe_fees').val() , bill_type:$('#dp_bill_type').val() };
        if(add_page==0)
            delete values.page;
        return values;
    }
    ...
    function LoadingData(){
        ...
        ajax_pager_data('#subscribers_types_tb > tbody',values);
    }

    function clear_form(){
        $('#txt_ser,#txt_subscriber_type,#txt_subscribe_fees').val('');
        $('#dp_bill_type').select2('val',0);
    }
