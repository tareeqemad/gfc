...
<div class="breadcrumb-header justify-content-between">
    ...
    <div class="justify-content-center mt-2">
        <ol class="breadcrumb">
            <li class="breadcrumb-item tx-15"><a href="javascript:void(0);">مشروع الفاقد</a></li>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="flex-shrink-0">
                    ...
                    <button type="button" onclick="$('#active_month_target_tb').tableExport({type:'excel',escape:'false'});"
...
<script type="text/javascript">
    ...
    function values_search(add_page){
        var values= {page:1,branch_no:$('#dp_branch_no').val(),activity_no:$('#dp_activity_no').val(),the_month:$('#txt_the_month').val()};
        if(add_page==0)
            delete values.page;
        return values;
    }
    ...
    function LoadingData(){
        ...
        ajax_pager_data('#active_month_target_tb > tbody',values);
    }
    
    function clear_form(){
        $('#txt_the_month').val('');
        $('#dp_emp_no,#dp_add_type').select2('val',0);
    }
    
    function show_row_details( branch,month ){
        get_to_link('{$get_url}/'+branch+'/'+month);
    }
