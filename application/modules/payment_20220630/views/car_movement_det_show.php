            ...
            <form id="<?= $TB_NAME ?>_form" method="post" action="<?= $create_url ?>">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div>
                            <input type="text" value="<?= $HaveRs ? $rs['PURPOSE_TYPE'] : "" ?>" name="purpose_type"
                                   id="txt_purpose_type"
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div>
                            <input
                                    placeholder="24:00"
                                    type="text"
                                    value="<?= $HaveRs ? $rs['EXPECTED_LEAVE_TIME'] : "" ?>"
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div>
                            <input placeholder="24:00"
                                   type="text"
                                   value="<?= $HaveRs ? $rs['EXPECTED_ARRIVAL_TIME'] : "" ?>"
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div>
                            <input type="text" value="<?= $HaveRs ? $rs['PREDEFINE_START_GPS'] : "" ?>"
                                   name="predefine_start_gps" id="txt_predefine_finished_gps"
                                   class="form-control ltr">
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div>
                            <input type="text" value="<?= $HaveRs ? $rs['PREDEFINE_FINISHED_GPS'] : "" ?>"
                                   name="predefine_finished_gps" id="txt_predefine_finished_gps"
                                   class="form-control ltr">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <div>
                            <input type="text" name="notes" value="<?= $HaveRs ? $rs['NOTES'] : "" ?>" id="txt_notes"
                                   class="form-control ltr">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div>
                            <input type="hidden" name="start_gps_location"
                                   value="<?= $HaveRs ? $rs['START_GPS_LOCATION'] : "" ?>" id="txt_predefine_start_gps"
                                   class="form-control ltr">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <div>
                            <input type="hidden" value="<?= $HaveRs ? $rs['FINISHED_GPS_LOCATION'] : "" ?>"
                                   name="finished_gps_location"
                                   id="txt_finished_gps_location"
                                   class="form-control ltr">
                            <button type="button" class="btn green"
