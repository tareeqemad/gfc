            ...
            <div class="modal-body inline_form">
                ...
                <div class="col-sm-10">
                    ...
                    <div class="form-group col-sm-2">
                        ...
                        <div>
                            <input type="text" <?=$date_attr?> name="req_start_date" id="txt_req_start_date" value="<?=date('d/m/Y',strtotime('-0 day'))?>" class="form-control">
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function LoadingData(){
        ...
        ajax_pager_data('#car_maintenance_workshop_tb > tbody',values);
    }
