        ...
        <fieldset>
            ...
            <div class="modal-body inline_form">
                ...
                <div class="form-group col-sm-1">
                    ...
                    <div class="">
                        <select name="checks_case" id="dp_checks_case" class="form-control">
                            <option value=""></option>
                            <option value="-1">________</option>
                            <option value="6">ملغي</option>
                            <?php foreach ($checks_case_cons  as $row) : ?>
                                <option value="<?= $row['CON_NO'] ?>"><?= $row['CON_NAME'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
...
$(function(){
    ...
    ajax_pager({check_id : $('#txt_check_id').val(),bank:$('#dp_check_bank_id').val(),price:$('#txt_price').val(),price_op:$('#price_op').val(),checks_case:$('#dp_checks_case').val()});

    }

    function LoadingData(){

    ajax_pager_data('#cashTbl > tbody',{check_id : $('#txt_check_id').val(),bank:$('#dp_check_bank_id').val(),price:$('#txt_price').val(),price_op:$('#price_op').val(),checks_case:$('#dp_checks_case').val()});
   ...
   function do_search(){
        ...
        get_data('{$get_page_url}/1/{$type}',{page: 1 ,check_id : $('#txt_check_id').val(),bank:$('#dp_check_bank_id').val(),price:$('#txt_price').val(),price_op:$('#price_op').val(),checks_case:$('#dp_checks_case').val()},function(data){
            $('#container').html(data);
