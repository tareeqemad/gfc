    ...
    <div class="col-md-2">
        <div style="padding: 0 10px">
            ...
            <div id="traching_div" style="padding: 10px 0">
                ...
                <div>
                    <input type="text" data-type="date" placeholder="تاريخ الحركة" data-date-format="DD/MM/YYYY" name="movment_date" id="txt_movment_date" class="form-control">
                </div>
                ...
                <div class="form-group col-sm-2">
                    ...
                    <div>
                        <input type="text" data-val="true" data-val-required="حقل مطلوب" placeholder="24:00" name="movment_time_from" id="txt_movment_time_from" data-val="true"  class="form-control" >
                ...
                <div class="form-group col-sm-2">
                    ...
                    <div>
                        <input type="text"  data-val="true" data-val-required="حقل مطلوب" placeholder="24:00" name="movment_time_to" id="txt_movment_time_to" data-val="true"  class="form-control" >
                ...
                <br>
                <div>
                    <input type="text" readonly placeholder="متوسط السرعة" name="avg_speed" id="txt_avg_speed" data-val="true" class="form-control ">
                </div>
                <br>
