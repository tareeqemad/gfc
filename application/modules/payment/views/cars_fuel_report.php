                ...
                <div class="form-group rp col-sm-2" id="rep_id">
                    ...
                    <div>
                        <select name="rep_id" class="form-control" id="dp_rep_id">
							...
							<option value="8">8- متوسط استهلاك الوقود</option>
                        </select>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function showOptions(){
        ...
        case "8":
            $(".op").fadeOut();
            $("#rep_type,#branch_id,#from_date_id,#to_date_id,#from_file_id,#to_file_id,#fuel_type_id").fadeIn();
            break; 
        }
    }
    ...
    function getReportUrl(){
        ...
        switch(id) {
            ...
            case "7":
                ...
                break;    
            case "8":
                repUrl = '{$report_url}&report_type='+rep_type+'&report=average_fuel_consumption&p_branch='+branch+'&p_from_car_file_id='+from_file+'&p_to_car_file_id='+to_file+'&p_fuel_type='+fuel_type+'&p_date_from='+from_date+'&p_date_to='+to_date+'';
                break;    
        }
        return repUrl;
    }
