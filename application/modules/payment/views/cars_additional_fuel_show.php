...
$adopt_action = $HaveRs ? ($rs['CARS_ADDITIONAL_FUEL'] == 2 ? 'adopt_fin': ($rs['CARS_ADDITIONAL_FUEL'] == 3 ? 'adopt_branch' : ($rs['CARS_ADDITIONAL_FUEL'] == 4 ? 'adopt_manager2' : ($rs['CARS_ADDITIONAL_FUEL'] == 5 ? 'adopt_manager3' : ($rs['CARS_ADDITIONAL_FUEL'] == 6 ? 'adopt_manager4' : ($rs['CARS_ADDITIONAL_FUEL'] == 7 ? 'adopt_manager5' : 'adopt')))))) : 'adopt';
            ...
            <form class="form-horizontal" id="cars_additional_fuel_form" method="post"
                ...
                <div class="modal-footer">
                  ...
                  <!--  <?php /*if (($HaveRs && $rs['CARS_ADDITIONAL_FUEL'] >= 2 && $rs['CARS_ADDITIONAL_FUEL'] < 7)): */?>
                    ...
                    <?php if ($HaveRs && $rs['CARS_ADDITIONAL_FUEL'] >= 1 && $rs['CARS_ADDITIONAL_FUEL'] < 8): ?>
