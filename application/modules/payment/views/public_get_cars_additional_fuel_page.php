                    ...
                    <?php if ($case > 3) : ?>
                        ...
                        <?php if ($case > 4) : ?>
                            ...
                            <?php if ($case > 5) : ?>
                                ...
                                <th> البيان</th>
                                <?php if ($case > 6) : ?>
                                    <th style="width: 100px;"> كمية الرقابة</th>
                                    <th> البيان</th>
                            <?php endif; ?>
                            <?php endif; ?>
                        <?php endif; ?>
        ...
        <?php if (count($details) <= 0) : ?>
            <tr>
                ...
                <?php if (count($details) > 0 && $case > 1) : ?>
                    ...
                    <td><input type="text" name="manager5_amount[]" value="" class="form-control"></td>
                    <td><input type="text" name="manager6_note[]" value="" class="form-control"></td>
                <?php endif; ?>
                    ...
                    <?php if ($case > 2) : ?>
                        ...
                        <?php if ($case > 3) : ?>
                            ...
                            <?php if ($case > 4) : ?>
                                ...
                                <?php if ($case > 6) : ?>
                                        <td><input type="text" name="manager5_amount[]"
                                                   value="<?= $row['MANAGER5_AMOUNT'] ?>"  <?= $case > 7 ? 'readonly' : '' ?>
                                                   class="form-control"></td>
                                        <td><input type="text" name="manager6_note[]"
                                                   value="<?= $row['MANAGER6_NOTE'] ?>"  <?= $case > 7 ? 'readonly' : '' ?>
                                                   class="form-control">
                                        </td>
