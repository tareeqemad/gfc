...
$jasper_rep_url = base_url("JsperReport/showreport?sys=financial/archives");
                 ...
                 case '1':
                   ...
                   switch(report_id){
                         case '1':
                          ...
                          url ='{$jasper_rep_url}&report_type=pdf&report=financial_book_chains_customer&p_account_id='+selected+'&p_to_account_id='+selected+'&p_from_date='+f_date+'&p_to_date='+t_date+'&p_branches='+branch+'&p_source='+$('#dp_fin_source').val()+'&p_curr_id='+$('#dp_currency').val()+'&p_username={$this->user->id}';
                         break;
