...
class Payment_cover_model extends MY_Model{
    var $PKG_NAME= "PAYMENT_PKG";
    var $TABLE_NAME= 'PAYMENT_COVER_TB';
    ...
    function get_list($sql,$offset,$row){
        ...
        $result = $this->New_rmodel->general_get($this->PKG_NAME,'PAYMENT_COVER_TB_GET_LIST',$params);
    ...
    function get_count($sql){
        ...
        $result = $this->New_rmodel->general_get($this->PKG_NAME,'PAYMENT_COVER_TB_GET_COUNT',$params);
