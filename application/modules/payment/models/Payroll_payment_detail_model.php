...
class Payroll_payment_detail_model extends MY_Model{
    var $PKG_NAME= "PAYMENT_PKG";
    var $TABLE_NAME= 'PAYROLL_PAYMENT_DETAIL_TB';
    ...
    function get_list($id= 0){
        ...
        $params =array(
            array('name'=>':PAYROLL_PAYMENT_ID ','value'=>$id ,'type'=>SQLT_INT,'length'=>-1),
    ...
    function delete($id){
        $params =array(
            array('name'=>':PAYROLL_PAYMENT_ID ','value'=>$id,'type'=>'','length'=>-1),
            array('name'=>':MSG_OUT','value'=>'MSG_OUT','type'=>SQLT_CHR,'length'=>-1),
        );
