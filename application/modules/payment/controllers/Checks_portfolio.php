...
class Checks_portfolio extends MY_Controller{
    ...
    function index($page = 1){
        ...
        $data['checks_case_cons'] = $this->constant_details_model->get_list(12);
        $data['page']=$page;
    ...
    function get_page($page = 1,$type){
        ...
        $sql .= isset($this->p_checks_case) && $this->p_checks_case !=null ? " AND  C.checks_case = {$this->p_checks_case} " :"" ;
