...
(function($){
    ...
    },plugins:["draggable","droppable","resizable","pagination","tooltip","linkbutton","menu","menubutton","splitbutton","progressbar","uitree","textbox","filebox","combo","combobox","combotree","combogrid","numberbox","validatebox","searchbox","spinner","numberspinner","timespinner","datetimespinner","calendar","datebox","datetimebox","slider","layout","panel","datagrid","propertygrid","uitreegrid","tabs","accordion","window","dialog","form"],parse:function(_2){
        var aa=[];
...
(function($){
    function _d2(_d3){
        var _d4=$(_d3);
        _d4.addClass("combotree");
        return _d4;
    };
    function _d5(_d6){
        var _d7=$.data(_d6,"uitree").options;
        $(_d6).unbind().bind("mouseover",function(e){
            var tt=$(e.target);
            var _d8=tt.closest("div.uitree-node");
            if(!_d8.length){
                return;
            }
            _d8.addClass("uitree-node-hover");
            if(tt.hasClass("uitree-hit")){
                if(tt.hasClass("uitree-expanded")){
                    tt.addClass("uitree-expanded-hover");
                }else{
                    tt.addClass("uitree-collapsed-hover");
                }
            }
            e.stopPropagation();
        }).bind("mouseout",function(e){
            var tt=$(e.target);
            var _d9=tt.closest("div.uitree-node");
            if(!_d9.length){
                return;
            }
            _d9.removeClass("uitree-node-hover");
            if(tt.hasClass("uitree-hit")){
                if(tt.hasClass("uitree-expanded")){
                    tt.removeClass("uitree-expanded-hover");
                }else{
                    tt.removeClass("uitree-collapsed-hover");
                }
            }
            e.stopPropagation();
        }).bind("click",function(e){
            var tt=$(e.target);
            var _da=tt.closest("div.uitree-node");
            if(!_da.length){
                return;
            }
            if(tt.hasClass("uitree-hit")){
                ...
                if(tt.hasClass("uitree-checkbox")){
                    _103(_d6,_da[0],!tt.hasClass("uitree-checkbox1"));
                    return false;
                }else{
                    _180(_d6,_da[0]);
            ...
            var _db=$(e.target).closest("div.uitree-node");
            if(!_db.length){
                return;
            }
            _180(_d6,_db[0]);
            ...
            var _dc=$(e.target).closest("div.uitree-node");
            if(!_dc.length){
                return;
            }
    ...
    function _de(_df){
        var _e0=$.data(_df,"uitree").options;
        _e0.dnd=false;
        var _e1=$(_df).find("div.uitree-node");
        _e1.draggable("disable");
        _e1.css("cursor","pointer");
    };
    function _e2(_e3){
        var _e4=$.data(_e3,"uitree");
        var _e5=_e4.options;
        var _e6=_e4.uitree;
        _e4.disabledNodes=[];
        _e5.dnd=true;
        _e6.find("div.uitree-node").draggable({disabled:false,revert:true,cursor:"pointer",proxy:function(_e7){
            var p=$("<div class=\"uitree-node-proxy\"></div>").appendTo("body");
            p.html("<span class=\"uitree-dnd-icon uitree-dnd-no\">&nbsp;</span>"+$(_e7).find(".tree-title").html());
            p.hide();
            return p;
            ...
            if($(e.target).hasClass("uitree-hit")||$(e.target).hasClass("uitree-checkbox")){
                return false;
            }
            if(e.which!=1){
                return false;
            }
            $(this).next("ul").find("div.uitree-node").droppable({accept:"no-accept"});
            var _e8=$(this).find("span.uitree-indent");
            if(_e8.length){
            ...
            if(_e9.id==undefined){
                _e9.id="easyui_uitree_node_id_temp";
                _11d(_e3,_e9);
            }
            ...
            $(this).next("ul").find("div.uitree-node").droppable({accept:"div.uitree-node"});
            for(var i=0;i<_e4.disabledNodes.length;i++){
                $(_e4.disabledNodes[i]).droppable("enable");
            }
            _e4.disabledNodes=[];
            var _ea=_178(_e3,_e4.draggingNodeId);
            if(_ea&&_ea.id=="easyui_uitree_node_id_temp"){
                _ea.id="";
                _11d(_e3,_ea);
            }
            _e5.onStopDrag.call(_e3,_ea);
        }}).droppable({accept:"div.uitree-node",onDragEnter:function(e,_eb){
            if(_e5.onDragEnter.call(_e3,this,_ec(_eb))==false){
                _ed(_eb,false);
                $(this).removeClass("uitree-node-append uitree-node-top uitree-node-bottom");
            ...
            if(_ef>top+(_f0-top)/2){
                if(_f0-_ef<5){
                    $(this).addClass("uitree-node-bottom");
                }else{
                    $(this).addClass("uitree-node-append");
                }
            }else{
                if(_ef-top<5){
                    $(this).addClass("uitree-node-top");
                }else{
                    $(this).addClass("uitree-node-append");
                }
            }
            ...
            var _f3=this;
            var _f4,_f5;
            if($(this).hasClass("uitree-node-append")){
                _f4=_f6;
                _f5="append";
            }else{
                _f4=_f7;
                _f5=$(this).hasClass("uitree-node-top")?"top":"bottom";
            }
        ...
        function _ec(_f8,pop){
            return $(_f8).closest("ul.uitree").uitree(pop?"pop":"getData",_f8);
        };
        function _ed(_f9,_fa){
            var _fb=$(_f9).draggable("proxy").find("span.uitree-dnd-icon");
            _fb.removeClass("uitree-dnd-yes uitree-dnd-no").addClass(_fa?"uitree-dnd-yes":"uitree-dnd-no");
        };
        function _f6(_fc,_fd){
            ...
            function _fe(){
                ...
                $(_e3).uitree("append",{parent:_fd,data:[_ff]});
    ...
    function _103(_104,_105,_106){
        ...
        var node=$(_105);
        var ck=node.find(".uitree-checkbox");
        ck.removeClass("uitree-checkbox0 uitree-checkbox1 uitree-checkbox2");
        if(_106){
            ck.addClass("uitree-checkbox1");
        }else{
            ck.addClass("uitree-checkbox0");
        }
        ...
        function _109(node){
            var _10a=node.next().find(".uitree-checkbox");
            _10a.removeClass("uitree-checkbox0 uitree-checkbox1 uitree-checkbox2");
            if(node.find(".uitree-checkbox").hasClass("uitree-checkbox1")){
                _10a.addClass("uitree-checkbox1");
            }else{
                _10a.addClass("uitree-checkbox0");
            }
        };
        function _108(node){
            var _10b=_145(_104,node[0]);
            if(_10b){
                var ck=$(_10b.target).find(".uitree-checkbox");
                ck.removeClass("uitree-checkbox0 uitree-checkbox1 uitree-checkbox2");
                if(_10c(node)){
                    ck.addClass("uitree-checkbox1");
                }else{
                    if(_10d(node)){
                        ...
                        ck.addClass("uitree-checkbox2");
                    }
                }
                _108($(_10b.target));
            }
            function _10c(n){
                var ck=n.find(".uitree-checkbox");
                if(ck.hasClass("uitree-checkbox0")||ck.hasClass("uitree-checkbox2")){
                    return false;
                }
                var b=true;
                n.parent().siblings().each(function(){
                    if(!$(this).children("div.uitree-node").children(".uitree-checkbox").hasClass("uitree-checkbox1")){
                        b=false;
                    }
                });
                return b;
            ...
            function _10d(n){
                var ck=n.find(".uitree-checkbox");
                if(ck.hasClass("uitree-checkbox1")||ck.hasClass("uitree-checkbox2")){
                    return false;
                }
                var b=true;
                n.parent().siblings().each(function(){
                    if(!$(this).children("div.uitree-node").children(".uitree-checkbox").hasClass("uitree-checkbox0")){
                        b=false;
                    }
                });
                return b;
    ...
    function _10e(_10f,_110){
        var opts=$.data(_10f,"uitree").options;
        if(!opts.checkbox){
            return;
        }
        var node=$(_110);
        if(_111(_10f,_110)){
            var ck=node.find(".uitree-checkbox");
            if(ck.length){
                if(ck.hasClass("uitree-checkbox1")){
                    _103(_10f,_110,true);
                }else{
                ...
                if(opts.onlyLeafCheck){
                    $("<span class=\"uitree-checkbox uitree-checkbox0\"></span>").insertBefore(node.find(".tree-title"));
                }
            }
        }else{
            var ck=node.find(".uitree-checkbox");
            if(opts.onlyLeafCheck){
                ...
                if(ck.hasClass("uitree-checkbox1")){
                    ...
                    if(ck.hasClass("uitree-checkbox2")){
                        var _112=true;
                        var _113=true;
    ...
    function _116(_117,ul,data,_118){
        var _119=$.data(_117,"uitree");
        var opts=_119.options;
        var _11a=$(ul).prevAll("div.uitree-node:first");
    ...
    function _122(_123,ul,_124){
        var opts=$.data(_123,"uitree").options;
        if(opts.lines){
            $(_123).addClass("uitree-lines");
        }else{
            $(_123).removeClass("uitree-lines");
            return;
        }
        if(!_124){
            _124=true;
            $(_123).find("span.uitree-indent").removeClass("uitree-line uitree-join uitree-joinbottom");
            $(_123).find("div.uitree-node").removeClass("uitree-node-last uitree-root-first uitree-root-one");
            var _125=$(_123).uitree("getRoots");
            if(_125.length>1){
                $(_125[0].target).addClass("uitree-root-first");
            }else{
                if(_125.length==1){
                    $(_125[0].target).addClass("uitree-root-one");
                }
            }
        }
        $(ul).children("li").each(function(){
            var node=$(this).children("div.uitree-node");
            var ul=node.next("ul");
            if(ul.length){
                if($(this).next().length){
                    _126(node);
        ...
        var _128=$(ul).children("li:last").children("div.uitree-node").addClass("uitree-node-last");
        _128.children("span.uitree-join").removeClass("uitree-join").addClass("uitree-joinbottom");
        function _127(node,_129){
            var icon=node.find("span.uitree-icon");
            icon.prev("span.uitree-indent").addClass("uitree-join");
        };
        function _126(node){
            var _12a=node.find("span.uitree-indent, span.uitree-hit").length;
            node.next().find("div.uitree-node").each(function(){
                $(this).children("span:eq("+(_12a-1)+")").addClass("uitree-line");
            });
        };
    };
    function _12b(_12c,ul,_12d,_12e){
        var opts=$.data(_12c,"uitree").options;
        ...
        var _130=$(ul).prev().children("span.uitree-folder");
        _130.addClass("uitree-loading");
        var _131=opts.loader.call(_12c,_12d,function(data){
            _130.removeClass("uitree-loading");
            _116(_12c,ul,data);
            if(_12e){
                _12e();
            }
    ...
    function _132(_133,_134,_135){
        var opts=$.data(_133,"uitree").options;
        var hit=$(_134).children("span.uitree-hit");
        if(hit.length==0){
            return;
        }
        if(hit.hasClass("uitree-expanded")){
            return;
        }
        ...
        hit.removeClass("uitree-collapsed uitree-collapsed-hover").addClass("uitree-expanded");
        hit.next().addClass("uitree-folder-open");
        var ul=$(_134).next();
        if(ul.length){
            if(opts.animate){
    ...
    function _137(_138,_139){
        var opts=$.data(_138,"uitree").options;
        var hit=$(_139).children("span.uitree-hit");
        if(hit.length==0){
            return;
        }
        if(hit.hasClass("uitree-collapsed")){
            return;
        }
        ...
        hit.removeClass("uitree-expanded uitree-expanded-hover").addClass("uitree-collapsed");
        hit.next().removeClass("uitree-folder-open");
        var ul=$(_139).next();
        if(opts.animate){
    ...
    function _13a(_13b,_13c){
        var hit=$(_13c).children("span.uitree-hit");
        if(hit.length==0){
            return;
        }
        if(hit.hasClass("uitree-expanded")){
    ...
    function _14d(_14e,_14f){
        ...
        if(node.length==0){
            ...
            if(_111(_14e,node[0])){
                var _150=node.find("span.uitree-icon");
                _150.removeClass("uitree-file").addClass("uitree-folder uitree-folder-open");
                var hit=$("<span class=\"uitree-hit uitree-expanded\"></span>").insertBefore(_150);
                if(hit.prev().length){
                    hit.prev().remove();
                }
            }
    ...
    function _151(_152,_153){
        ...
        var _155=_154?_154.children:$(_152).uitree("getRoots");
    ...
    function _156(_157,_158){
        ...
        if(_159){
            if(!_159.children||!_159.children.length){
                ...
                node.find(".uitree-icon").removeClass("uitree-folder").addClass("uitree-file");
                node.find(".uitree-hit").remove();
                $("<span class=\"uitree-indent\"></span>").prependTo(node);
                node.next().remove();
            }
            _11d(_157,_159);
        ...
        function del(_15a){
            ...
            var cc=_15b?_15b.children:$.data(_157,"uitree").data;
    ...
    function _11d(_15c,_15d){
        var opts=$.data(_15c,"uitree").options;
        var node=$(_15d.target);
        var _15e=data.checked;
        if(data.iconCls){
            node.find(".uitree-icon").removeClass(data.iconCls);
        }
        $.extend(data,_15d);
        node.find(".tree-title").html(opts.formatter.call(_15c,data));
        if(data.iconCls){
            node.find(".uitree-icon").addClass(data.iconCls);
        }
    ...
    function _163(_164){
        var _165=$.data(_164,"uitree").data;
    ...
    function _115(_167,_168){
        var _169=[];
        var n=_dd(_167,_168);
        var data=n?n.children:$.data(_167,"uitree").data;
        _120(data,function(node){
            _169.push(_166(node));
        });
        return _169;
    ...
    function _145(_16a,_16b){
        var p=$(_16b).closest("ul").prevAll("div.uitree-node:first");
        return _dd(_16a,p[0]);
    };
    function _16c(_16d,_16e){
        ...
        for(var i=0;i<_16e.length;i++){
            var s=_16e[i];
            if(s=="checked"){
                _16f.push("span.uitree-checkbox1");
            }else{
                if(s=="unchecked"){
                    _16f.push("span.uitree-checkbox0");
                }else{
                    if(s=="indeterminate"){
                        _16f.push("span.uitree-checkbox2");
                    }
                }
            }
        }
    ...
    function _171(_172){
        var node=$(_172).find("div.uitree-node-selected");
    ...
    function _11c(_17a,_17b,_17c){
        var data=$.data(_17a,"uitree").data;
        var _17d=null;
        _120(data,function(node){
            if(node[_17b]==_17c){
                _17d=_166(node);
    ...
    function _166(node){
        var d=$("#"+node.domId);
        node.target=d[0];
        node.checked=d.find(".uitree-checkbox").hasClass("uitree-checkbox1");
        return node;
    };
    ...
    function _180(_181,_182){
        var opts=$.data(_181,"uitree").options;
        var node=_dd(_181,_182);
        if(opts.onBeforeSelect.call(_181,node)==false){
            return;
        }
        $(_181).find("div.uitree-node-selected").removeClass("uitree-node-selected");
        $(_182).addClass("uitree-node-selected");
        opts.onSelect.call(_181,node);
    };
    function _111(_183,_184){
        return $(_184).children("span.uitree-hit").length==0;
    };
    function _185(_186,_187){
        var opts=$.data(_186,"uitree").options;
        ...
        nt.empty();
        var _189=$("<input class=\"uitree-editor\">").appendTo(nt);
    ...
    function _18a(_18b,_18c){
        var opts=$.data(_18b,"uitree").options;
        $(_18c).css("position","");
        var _18d=$(_18c).find("input.uitree-editor");
        var val=_18d.val();
        _18d.remove();
    ...
    function _18e(_18f,_190){
        var opts=$.data(_18f,"uitree").options;
        $(_190).css("position","");
        $(_190).find("input.uitree-editor").remove();
        var node=_dd(_18f,_190);
        _11d(_18f,node);
        opts.onCancelEdit.call(_18f,node);
    };
    $.fn.uitree=function(_191,_192){
        if(typeof _191=="string"){
            return $.fn.uitree.methods[_191](this,_192);
        }
        var _191=_191||{};
        return this.each(function(){
            var _193=$.data(this,"uitree");
            var opts;
            if(_193){
                opts=$.extend(_193.options,_191);
                _193.options=opts;
            }else{
                opts=$.extend({},$.fn.uitree.defaults,$.fn.uitree.parseOptions(this),_191);
                $.data(this,"uitree",{options:opts,uitree:_d2(this),data:[]});
                var data=$.fn.uitree.parseData(this);
                if(data.length){
                    _116(this,this,data);
                }
            }
    ...
    $.fn.uitree.methods={options:function(jq){
        return $.data(jq[0],"uitree").options;
        ...
        return jq.each(function(){
            if(_196){
                var node=$(_196);
                var hit=node.children("span.uitree-hit");
                hit.removeClass("uitree-expanded uitree-expanded-hover").addClass("uitree-collapsed");
                node.next().remove();
                _132(this,_196);
            }else{
        ...
        var node=jq.uitree("getData",_1a9);
        jq.uitree("remove",_1a9);
        return node;
    ...
    $.fn.uitree.parseOptions=function(_1ae){
        var t=$(_1ae);
    ...
    $.fn.uitree.parseData=function(_1af){
        var data=[];
        _1b0(data,$(_1af));
        return data;
        function _1b0(aa,uitree){
            uitree.children("li").each(function(){
                var node=$(this);
    ...
    var _1b3={render:function(_1b4,ul,data){
        var opts=$.data(_1b4,"uitree").options;
        var _1b5=$(ul).prev("div.uitree-node").find("span.uitree-indent, span.uitree-hit").length;
        ...
        function _1b6(_1b7,_1b8){
            ...
            for(var i=0;i<_1b8.length;i++){
                ...
                item.domId="_easyui_uitree_"+_1b2++;
                cc.push("<li>");
                cc.push("<div id=\""+item.domId+"\" class=\"uitree-node\">");
                for(var j=0;j<_1b7;j++){
                    cc.push("<span class=\"uitree-indent\"></span>");
                }
                var _1b9=false;
                if(item.state=="closed"){
                    cc.push("<span class=\"uitree-hit uitree-collapsed\"></span>");
                    cc.push("<span class=\"uitree-icon uitree-folder "+(item.iconCls?item.iconCls:"")+"\"></span>");
                }else{
                    if(item.children&&item.children.length){
                        cc.push("<span class=\"uitree-hit uitree-expanded\"></span>");
                        cc.push("<span class=\"uitree-icon uitree-folder uitree-folder-open "+(item.iconCls?item.iconCls:"")+"\"></span>");
                    }else{
                        cc.push("<span class=\"uitree-indent\"></span>");
                        cc.push("<span class=\"uitree-icon uitree-file "+(item.iconCls?item.iconCls:"")+"\"></span>");
                        _1b9=true;
                    }
                }
                if(opts.checkbox){
                    if((!opts.onlyLeafCheck)||_1b9){
                        cc.push("<span class=\"uitree-checkbox uitree-checkbox0\"></span>");
                    }
                }

                cc.push("<span class=\"tree-title\" data-id=\""+item.id+"\">"+opts.formatter.call(_1b4,item)+"</span>");
                cc.push("</div>");
                if(item.children&&item.children.length){
    ...
    $.fn.uitree.defaults={url:null,method:"post",animate:false,checkbox:false,cascadeCheck:true,onlyLeafCheck:false,lines:false,dnd:false,data:null,queryParams:{},formatter:function(node){
        return node.text;
    },loader:function(_1ba,_1bb,_1bc){
        var opts=$(this).uitree("options");
        if(!opts.url){
            return false;
        }
...
(function($){
    ...
    function _436(_437){
        ...
        function _43a(){
            ...
            if(opts.required){
                box.attr('data-val','true');
                box.attr('data-val-required','حقل مطلوب');
...
(function($){
    ...
    function _616(_617){
        ...
        if(opts.idField){
            var _619=$.data(_617,"uitreegrid")?true:false;
...
(function($){
    function _7b7(_7b8){
        ...
        $(_7b8).datagrid($.extend({},opts,{url:null,data:null,loader:function(){
            ...
            if(opts.remoteSort){
                ...
                var data=$(_7b8).uitreegrid("getData");
                _7e6(_7b8,0,data);
            }
    ...
    function _7d9(_7da){
        ...
        var opts=$.data(_7da,"uitreegrid").options;
        if(!opts.rownumbers){
            return;
        }
    ...
    function _7db(_7dc){
        ...
        dc.body1.add(dc.body2).bind("mouseover",function(e){
            ...
            if(tt.hasClass("uitree-hit")){
                tt.hasClass("uitree-expanded")?tt.addClass("uitree-expanded-hover"):tt.addClass("uitree-collapsed-hover");
            }
        }).bind("mouseout",function(e){
            var tt=$(e.target);
            var tr=tt.closest("tr.datagrid-row");
            ...
            if(tt.hasClass("uitree-hit")){
                tt.hasClass("uitree-expanded")?tt.removeClass("uitree-expanded-hover"):tt.removeClass("uitree-collapsed-hover");
            }
    ...
    function _7df(_7e0,_7e1){
        var opts=$.data(_7e0,"uitreegrid").options;
        ...
        function _7e4(tr,_7e5){
            $("<tr class=\"uitreegrid-tr-uitree\">"+"<td style=\"border:0px\" colspan=\""+_7e5+"\">"+"<div></div>"+"</td>"+"</tr>").insertAfter(tr);
        };
    };
    function _7e6(_7e7,_7e8,data,_7e9){
        var _7ea=$.data(_7e7,"uitreegrid");
        ...
        if(node){
            ...
            var cc1=_7eb.next("tr.uitreegrid-tr-uitree").children("td").children("div");
            var cc2=_7ec.next("tr.uitreegrid-tr-uitree").children("td").children("div");
            if(!_7e9){
                node.children=[];
            }
        }else{
        ...
        if(!_7e8&&opts.pagination){
            var _7ed=$.data(_7e7,"uitreegrid").total;
        ...
        _7d1(_7e7);
        _7d9(_7e7);
        $(_7e7).uitreegrid("showLines");
        $(_7e7).uitreegrid("setSelectionState");
        $(_7e7).uitreegrid("autoSizeColumn");
        opts.onLoadSuccess.call(_7e7,node,data);
    };
    function _7d0(_7ef,_7f0,_7f1,_7f2,_7f3){
        var opts=$.data(_7ef,"uitreegrid").options;
        ...
        var _7f5=body.find("tr[node-id=\""+_7f0+"\"] span.uitree-folder");
        _7f5.addClass("uitree-loading");
        $(_7ef).uitreegrid("loading");
        var _7f6=opts.loader.call(_7ef,_7f4,function(data){
            _7f5.removeClass("uitree-loading");
            $(_7ef).uitreegrid("loaded");
    ...
    function _7f9(_7fa){
        return $.data(_7fa,"uitreegrid").data;
    };
    ...
    function _7d5(_7fe,_7ff){
        var opts=$.data(_7fe,"uitreegrid").options;
    ...
    function _806(_807,_808){
        ...
        var opts=$.data(_807,"uitreegrid").options;
        var view=$(_807).datagrid("getPanel").children("div.datagrid-view");
        var node=view.find("div.datagrid-body tr[node-id=\""+_808+"\"]").children("td[field=\""+opts.uitreeField+"\"]");
        return node.find("span.uitree-indent,span.uitree-hit").length;
    };
    function find(_809,_80a){
        var opts=$.data(_809,"uitreegrid").options;
        var data=$.data(_809,"uitreegrid").data;
        var cc=[data];
        while(cc.length){
            var c=cc.shift();
    ...
    function _80b(_80c,_80d){
        var opts=$.data(_80c,"uitreegrid").options;
        var row=find(_80c,_80d);
        var tr=opts.finder.getTr(_80c,_80d);
        var hit=tr.find("span.uitree-hit");
        if(hit.length==0){
            return;
        }
        if(hit.hasClass("uitree-collapsed")){
        ...
        hit.next().removeClass("uitree-folder-open");
        row.state="closed";
        tr=tr.next("tr.uitreegrid-tr-uitree");
        var cc=tr.children("td").children("div");
        if(opts.animate){
            cc.slideUp("normal",function(){
                $(_80c).uitreegrid("autoSizeColumn");
                _7d1(_80c,_80d);
    ...
    function _80e(_80f,_810){
        var opts=$.data(_80f,"uitreegrid").options;
        ...
        hit.removeClass("uitree-collapsed uitree-collapsed-hover").addClass("uitree-expanded");
        hit.next().addClass("uitree-folder-open");
        var _811=tr.next("tr.uitreegrid-tr-uitree");
        if(_811.length){
        ...
        function _812(cc){
            ...
            if(opts.animate){
                cc.slideDown("normal",function(){
                    $(_80f).uitreegrid("autoSizeColumn");
                    _7d1(_80f,_810);
    ...
    function _7de(_814,_815){
        var opts=$.data(_814,"uitreegrid").options;
    ...
    function _816(_817,_818){
        var opts=$.data(_817,"uitreegrid").options;
    ...
    function _81a(_81b,_81c){
        var opts=$.data(_81b,"uitreegrid").options;
    ...
    function _81e(_81f,_820){
        var opts=$.data(_81f,"uitreegrid").options;
        var ids=[];
    ...
    function _821(_822,_823){
        var opts=$.data(_822,"uitreegrid").options;
        if(_823.parent){
            var tr=opts.finder.getTr(_822,_823.parent);
            if(tr.next("tr.uitreegrid-tr-uitree").length==0){
                _7df(_822,_823.parent);
            }
            var cell=tr.children("td[field=\""+opts.uitreeField+"\"]").children("div.datagrid-cell");
            var _824=cell.children("span.uitree-icon");
            if(_824.hasClass("uitree-file")){
                _824.removeClass("uitree-file").addClass("uitree-folder uitree-folder-open");
                var hit=$("<span class=\"uitree-hit uitree-expanded\"></span>").insertBefore(_824);
                if(hit.prev().length){
                    hit.prev().remove();
                }
            }
    ...
    function _825(_826,_827){
        ...
        var opts=$.data(_826,"uitreegrid").options;
        var _828=_7fb(_826,ref);
        _821(_826,{parent:(_828?_828[opts.idField]:null),data:[_827.data]});
        var _829=_828?_828.children:$(_826).uitreegrid("getRoots");
        ...
        function _82b(_82c){
            ...
            if(_827.before){
                ...
                var sub=dest.next("tr.uitreegrid-tr-uitree");
    ...
    function _82f(_830,_831){
        var _832=$.data(_830,"uitreegrid");
        $(_830).datagrid("deleteRow",_831);
        _7d9(_830);
        _832.total-=1;
        $(_830).datagrid("getPager").pagination("refresh",{total:_832.total});
        $(_830).uitreegrid("showLines");
    };
    function _833(_834){
        var t=$(_834);
        var opts=t.uitreegrid("options");
        if(opts.lines){
            t.uitreegrid("getPanel").addClass("uitree-lines");
        }else{
            t.uitreegrid("getPanel").removeClass("uitree-lines");
            return;
        }
        t.uitreegrid("getPanel").find("span.uitree-indent").removeClass("uitree-line uitree-join uitree-joinbottom");
        t.uitreegrid("getPanel").find("div.datagrid-cell").removeClass("uitree-node-last uitree-root-first uitree-root-one");
        var _835=t.uitreegrid("getRoots");
        if(_835.length>1){
            _836(_835[0]).addClass("uitree-root-first");
        }else{
            if(_835.length==1){
                _836(_835[0]).addClass("uitree-root-one");
            }
        }
        _837(_835);
        _838(_835);
        function _837(_839){
            $.map(_839,function(node){
                if(node.children&&node.children.length){
                    ...
                    var cell=_836(node);
                    cell.find(".uitree-icon").prev().addClass("uitree-join");
                }
            });
            var cell=_836(_839[_839.length-1]);
            cell.addClass("uitree-node-last");
            cell.find(".uitree-join").removeClass("uitree-join").addClass("uitree-joinbottom");
        };
        function _838(_83a){
            ...
            for(var i=0;i<_83a.length-1;i++){
                var node=_83a[i];
                var _83b=t.uitreegrid("getLevel",node[opts.idField]);
                var tr=opts.finder.getTr(_834,node[opts.idField]);
                var cc=tr.next().find("tr.datagrid-row td[field=\""+opts.uitreeField+"\"] div.datagrid-cell");
                cc.find("span:eq("+(_83b-1)+")").addClass("uitree-line");
            }
        };
        function _836(node){
            var tr=opts.finder.getTr(_834,node[opts.idField]);
            var cell=tr.find("td[field=\""+opts.uitreeField+"\"] div.datagrid-cell");
            return cell;
        };
    };
    $.fn.uitreegrid=function(_83c,_83d){
        if(typeof _83c=="string"){
            var _83e=$.fn.uitreegrid.methods[_83c];
            if(_83e){
        ...
        _83c=_83c||{};
        return this.each(function(){
            var _83f=$.data(this,"uitreegrid");
            if(_83f){
                $.extend(_83f.options,_83c);
            }else{
                _83f=$.data(this,"uitreegrid",{options:$.extend({},$.fn.uitreegrid.defaults,$.fn.uitreegrid.parseOptions(this),_83c),data:[]});
            }
            _7b7(this);
            if(_83f.options.data){
                $(this).uitreegrid("loadData",_83f.options.data);
            }
            _7d0(this);
            _7db(this);
        });
    };
    $.fn.uitreegrid.methods={options:function(jq){
        return $.data(jq[0],"uitreegrid").options;
        ...
        return jq.each(function(){
            $(this).uitreegrid("options").pageNumber=1;
            $(this).uitreegrid("getPager").pagination({pageNumber:1});
            $(this).uitreegrid("reload",_842);
        });
    },reload:function(jq,id){
        return jq.each(function(){
            var opts=$(this).uitreegrid("options");
            var _843={};
            if(typeof id=="object"){
                _843=id;
            }else{
            ...
            if(_843.id){
                var node=$(this).uitreegrid("find",_843.id);
                if(node.children){
                    node.children.splice(0,node.children.length);
                }
                opts.queryParams=_843;
                var tr=opts.finder.getTr(this,_843.id);
                tr.next("tr.uitreegrid-tr-uitree").remove();
                tr.find("span.uitree-hit").removeClass("uitree-expanded uitree-expanded-hover").addClass("uitree-collapsed");
                _80e(this,_843.id);
            }else{
                _7d0(this,null,_843);
            }
        ...
        return jq.each(function(){
            var opts=$.data(this,"uitreegrid").options;
            var dc=$.data(this,"datagrid").dc;
            if(_844){
                $.data(this,"uitreegrid").footer=_844;
            }
            if(opts.showFooter){
                opts.view.renderFooter.call(opts.view,this,dc.footer1,true);
                opts.view.renderFooter.call(opts.view,this,dc.footer2,false);
                ...
                $(this).uitreegrid("fixRowHeight");
            }
        });
    },getData:function(jq){
        return $.data(jq[0],"uitreegrid").data;
    },getFooterRows:function(jq){
        return $.data(jq[0],"uitreegrid").footer;
    },getRoot:function(jq){
        return _7f7(jq[0]);
    },getRoots:function(jq){
        return _7f9(jq[0]);
        ...
        var opts=$.data(jq[0],"uitreegrid").options;
        ...
        var row=jq.uitreegrid("find",id);
        jq.uitreegrid("remove",id);
        return row;
        ...
        return jq.each(function(){
            ...
            $(this).uitreegrid("fixRowHeight",id);
        });
    ...
    $.fn.uitreegrid.parseOptions=function(_848){
        return $.extend({},$.fn.datagrid.parseOptions(_848),$.parser.parseOptions(_848,["uitreeField",{animate:"boolean"}]));
    };
    var _849=$.extend({},$.fn.datagrid.defaults.view,{render:function(_84a,_84b,_84c){
        var opts=$.data(_84a,"uitreegrid").options;
        ...
        var view=this;
        if(this.uitreeNodes&&this.uitreeNodes.length){
            var _84f=_850(_84c,this.uitreeLevel,this.uitreeNodes);
            $(_84b).append(_84f.join(""));
        }
        function _850(_851,_852,_853){
            var _854=$(_84a).uitreegrid("getParent",_853[0][opts.idField]);
            var _855=(_854?_854.children.length:$(_84a).uitreegrid("getRoots").length)-_853.length;
            ...
            for(var i=0;i<_853.length;i++){
                ...
                if(row.children&&row.children.length){
                    ...
                    _856.push("<tr class=\"uitreegrid-tr-uitree\"><td style=\"border:0px\" colspan="+(_84d.length+(opts.rownumbers?1:0))+"><div style=\"display:"+v+"\">");
                    _856=_856.concat(tt);
                    _856.push("</div></td></tr>");
                }
            }
        ...
        var opts=$.data(_85b,"uitreegrid").options;
        var rows=$.data(_85b,"uitreegrid").footer||[];
        ...
        var opts=$.data(_860,"uitreegrid").options;
        var cc=[];
        ...
        for(var i=0;i<_861.length;i++){
            ...
            if(col){
                ...
                if(col.checkbox){
                    ...
                    if(_864==opts.uitreeField){
                        for(var j=0;j<_863;j++){
                            cc.push("<span class=\"uitree-indent\"></span>");
                        }
                        if(row.state=="closed"){
                            cc.push("<span class=\"uitree-hit uitree-collapsed\"></span>");
                            cc.push("<span class=\"uitree-icon uitree-folder "+(row.iconCls?row.iconCls:"")+"\"></span>");
                        }else{
                            if(row.children&&row.children.length){
                                cc.push("<span class=\"uitree-hit uitree-expanded\"></span>");
                                cc.push("<span class=\"uitree-icon uitree-folder uitree-folder-open "+(row.iconCls?row.iconCls:"")+"\"></span>");
                            }else{
                                cc.push("<span class=\"uitree-indent\"></span>");
                                cc.push("<span class=\"uitree-icon uitree-file "+(row.iconCls?row.iconCls:"")+"\"></span>");
                            }
                        }
        ...
        var opts=$.data(_869,"uitreegrid").options;
        var _86a=$(_869).uitreegrid("find",id);
        $.extend(_86a,row);
        var _86b=$(_869).uitreegrid("getLevel",id)-1;
        var _86c=opts.rowStyler?opts.rowStyler.call(_869,_86a):"";
        var _86d=$.data(_869,"datagrid").rowIdPrefix;
        var _86e=_86a[opts.idField];
        function _86f(_870){
            var _871=$(_869).uitreegrid("getColumnFields",_870);
        ...
        $(_869).uitreegrid("fixRowHeight",id);
    },deleteRow:function(_874,id){
        var opts=$.data(_874,"uitreegrid").options;
        ...
        if(_875){
            if(_875.children.length==0){
                ...
                tr.next("tr.uitreegrid-tr-uitree").remove();
                var cell=tr.children("td[field=\""+opts.uitreeField+"\"]").children("div.datagrid-cell");
                cell.find(".uitree-icon").removeClass("uitree-folder").addClass("uitree-file");
                cell.find(".uitree-hit").remove();
                $("<span class=\"uitree-indent\"></span>").prependTo(cell);
            }
        }
        function del(id){
            var cc;
            var _876=$(_874).uitreegrid("getParent",id);
            if(_876){
                cc=_876.children;
            }else{
                cc=$(_874).uitreegrid("getData");
            }
            for(var i=0;i<cc.length;i++){
        ...
        this.sort(_877,data);
        this.uitreeNodes=data;
        this.uitreeLevel=$(_877).uitreegrid("getLevel",_878);
    },sort:function(_87d,data){
        var opts=$.data(_87d,"uitreegrid").options;
        if(!opts.remoteSort&&opts.sortName){
        ...
        function _880(rows){
            rows.sort(function(r1,r2){
                ...
                for(var i=0;i<_87e.length;i++){
                    var sn=_87e[i];
                    var so=_87f[i];
                    var col=$(_87d).uitreegrid("getColumnOption",sn);
        ...
        var opts=$.data(_883,"uitreegrid").options;
        var rows=[];
        for(var i=0;i<data.length;i++){
            rows.push(data[i]);
        }
    ...
    $.fn.uitreegrid.defaults=$.extend({},$.fn.datagrid.defaults,{uitreeField:null,lines:false,animate:false,singleSelect:true,view:_849,loader:function(_886,_887,_888){
        var opts=$(this).uitreegrid("options");
        if(!opts.url){
            return false;
        }
        ...
        if(_88b==0){
            var opts=$.data(_88a,"uitreegrid").options;
        ...
        return $(_88c).uitreegrid("find",id);
    },getRows:function(_88d){
        return $(_88d).uitreegrid("getChildren");
...
(function($){
    function _926(_927){
        ...
        var uitree=_928.uitree;
        $(_927).addClass("combotree-f");
        $(_927).combo(opts);
        var _929=$(_927).combo("panel");
        if(!uitree){
            uitree=$("<ul></ul>").appendTo(_929);
            $.data(_927,"combotree").uitree=uitree;
        }
        uitree.uitree($.extend({},opts,{checkbox:opts.multiple,onLoadSuccess:function(node,data){
            var _92a=$(_927).combotree("getValues");
            if(opts.multiple){
                var _92b=uitree.uitree("getChecked");
            ...
            if(opts.multiple){
                $(this).uitree(node.checked?"uncheck":"check",node.target);
            }else{
    ...
    function _930(_931){
        ...
        var uitree=_932.uitree;
        var vv=[],ss=[];
        if(opts.multiple){
            var _933=uitree.uitree("getChecked");
            for(var i=0;i<_933.length;i++){
                vv.push(_933[i].id);
                ss.push(_933[i].text);
            }
        }else{
            var node=uitree.uitree("getSelected");
            if(node){
                vv.push(node.id);
                ss.push(node.text);
            }
    ...
    function _934(_935,_936){
        ...
        var uitree=$.data(_935,"combotree").uitree;
        uitree.find("span.uitree-checkbox").addClass("uitree-checkbox0").removeClass("uitree-checkbox1 uitree-checkbox2");
        var vv=[],ss=[];
        for(var i=0;i<_936.length;i++){
            var v=_936[i];
            var s=v;
            var node=uitree.uitree("find",v);
            if(node){
                s=node.text;
                uitree.uitree("check",node.target);
                uitree.uitree("select",node.target);
            }
            vv.push(v);
            ss.push(s);
        }
    ...
    $.fn.combotree.methods={options:function(jq){
        ...
        return $.data(jq[0],"combotree").uitree;
    },loadData:function(jq,data){
        return jq.each(function(){
            var opts=$.data(this,"combotree").options;
            opts.data=data;
            var uitree=$.data(this,"combotree").uitree;
            uitree.uitree("loadData",data);
        });
    },reload:function(jq,url){
        return jq.each(function(){
            var opts=$.data(this,"combotree").options;
        ...
        return jq.each(function(){
            var uitree=$.data(this,"combotree").uitree;
            uitree.find("div.uitree-node-selected").removeClass("uitree-node-selected");
            var cc=uitree.uitree("getChecked");
            for(var i=0;i<cc.length;i++){
                uitree.uitree("uncheck",cc[i].target);
            }
            $(this).combo("clear");
        });
    },reset:function(jq){
    ...
    $.fn.combotree.parseOptions=function(_93e){
        return $.extend({},$.fn.combo.parseOptions(_93e),$.fn.uitree.parseOptions(_93e));
    };
    $.fn.combotree.defaults=$.extend({},$.fn.combo.defaults,$.fn.uitree.defaults,{editable:false});
})(jQuery);
(function($){
    function _93f(_940){
