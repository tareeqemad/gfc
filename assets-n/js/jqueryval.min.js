(function (n) {
    ...
    n(document).on("click", "form[data-ajax=true] input[type=image]", function (i) {
        ...
        n(f).data(t, [{name: r + ".x", value: Math.round(i.pageX - e.left)}, {
            name: r + ".y",
    ...
    n.extend(n.fn, {
        ...
        messages: {
            ...
            date: "ادخل تاريخ صحيح",
            dateISO: "ادخل تاريخ صحيح (ISO).",
            ...
            max: n.validator.format("ادخل قيمة اقل او تساوي {0}."),
            min: n.validator.format("ادخل قيمة اكبر او تساوي {0}.")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function () {
                ...
                var f = n(t).rules(), e = !1, o = this.elementValue(t), i;
                for (r in f) {
    ...
    r.unobtrusive = {
        adapters: [], parseElement: function (t, i) {
            ...
            var i = n(t).parents("form").addBack().add(n(t).find("form")).filter("form");
